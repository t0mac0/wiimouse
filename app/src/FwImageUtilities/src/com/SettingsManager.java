...
public class SettingsManager extends java.util.Properties {
	/**
	 * Use a Vector to keep a copy of lines that are a comment or 'blank'
	 */
	public Vector<Object> lineData = new Vector<Object>(0, 1);

	/**
	 * Use a Vector to keep a copy of lines containing a key, i.e. they are a property.
	 */
	public Vector<Object> keyData = new Vector<Object>(0, 1);
	...
	/**
	 * Overrides Properties Object setProperty to update keyData
	 */
