...
/*---------------------------- I2Cx CR2 Configuration ------------------------*/
  ...
  freqrange = (uint16)(pclk1clock / 1000000);
  tmpreg |= freqrange;
  /* Write to I2Cx CR2 */
  I2Cx->CR2 = tmpreg;
...
/*---------------------------- I2Cx CCR Configuration ------------------------*/
  ...
  if (I2C_InitStruct->I2C_ClockSpeed <= 100000)
  {
    ...
    result = (uint16)(pclk1clock / (I2C_InitStruct->I2C_ClockSpeed << 1));
  ...
  else /*(I2C_InitStruct->I2C_ClockSpeed <= 400000)*/
  {
    if (I2C_InitStruct->I2C_DutyCycle == I2C_DutyCycle_2)
    {
      ...
      result = (uint16)(pclk1clock / (I2C_InitStruct->I2C_ClockSpeed * 3));
    }
    else /*I2C_InitStruct->I2C_DutyCycle == I2C_DutyCycle_16_9*/
    {
      /* Fast mode speed calculate: Tlow/Thigh = 16/9 */
      result = (uint16)(pclk1clock / (I2C_InitStruct->I2C_ClockSpeed * 25));
      /* Set DUTY bit */
    ...
    I2Cx->TRISE = (uint16)(((freqrange * 300) / 1000) + 1);  
  }
  /* Write to I2Cx CCR */
  I2Cx->CCR = tmpreg;
...
void I2C_OwnAddress2Config(I2C_TypeDef* I2Cx, uint8 Address)
{
  ...
  tmpreg |= (uint16)(Address & (uint16)0x00FE);
...
FlagStatus I2C_GetFlagStatus(I2C_TypeDef* I2Cx, uint32 I2C_FLAG)
{
  ...
  if ((i2cstatus & I2C_FLAG) != (uint32)RESET)
  {
    /* I2C_FLAG is set */
    bitstatus = SET;
  }
...
ITStatus I2C_GetITStatus(I2C_TypeDef* I2Cx, uint32 I2C_IT)
{
  ...
  /* Check the status of the specified I2C flag */
  if ((i2cstatus & I2C_IT) != (uint32)RESET)
  {
    /* I2C_IT is set */
    bitstatus = SET;
  }
