...
/* Private define ------------------------------------------------------------*/
/* DMA ENABLE mask */
#define CCR_ENABLE_Set          ((uint32)0x00000001)
#define CCR_ENABLE_Reset        ((uint32)0xFFFFFFFE)

/* DMA Channelx interrupt pending bit masks */
#define DMA_Channel1_IT_Mask    ((uint32)0x0000000F)
#define DMA_Channel2_IT_Mask    ((uint32)0x000000F0)
#define DMA_Channel3_IT_Mask    ((uint32)0x00000F00)
#define DMA_Channel4_IT_Mask    ((uint32)0x0000F000)
#define DMA_Channel5_IT_Mask    ((uint32)0x000F0000)
#define DMA_Channel6_IT_Mask    ((uint32)0x00F00000)
#define DMA_Channel7_IT_Mask    ((uint32)0x0F000000)

/* DMA registers Masks */
#define CCR_CLEAR_Mask          ((uint32)0xFFFF800F)
...
uint16 DMA_GetCurrDataCounter(DMA_Channel_TypeDef*  DMA_Channelx)
{
  ...
  return ((uint16)(DMA_Channelx->CNDTR));
}
...
FlagStatus DMA_GetFlagStatus(uint32 DMA_FLAG)
{
  ...
  if ((DMA->ISR & DMA_FLAG) != (uint32)RESET)
  {
    /* DMA_FLAG is set */
    bitstatus = SET;
  }
...
ITStatus DMA_GetITStatus(uint32 DMA_IT)
{
  ...
  if ((DMA->ISR & DMA_IT) != (uint32)RESET)
  {
    /* DMA_IT is set */
    bitstatus = SET;
  }
