...
/* Private define ------------------------------------------------------------*/
/* ADC ADON mask */
#define CR2_ADON_Set               ((uint32)0x00000001)
#define CR2_ADON_Reset             ((uint32)0xFFFFFFFE)

/* ADC DMA mask */
#define CR2_DMA_Set                ((uint16)0x0100)
#define CR2_DMA_Reset              ((uint16)0xFEFF)

/* ADC RSTCAL mask */
#define CR2_RSTCAL_Set             ((uint16)0x0008)

/* ADC CAL mask */
#define CR2_CAL_Set                ((uint16)0x0004)

/* ADC SWSTRT mask */
#define CR2_SWSTRT_Set             ((uint32)0x00400000)
...
/* ADC EXTTRIG mask */
#define CR2_EXTTRIG_Set            ((uint32)0x00100000)
#define CR2_EXTTRIG_Reset          ((uint32)0xFFEFFFFF)

/* ADC Software start mask */
#define CR2_EXTTRIG_SWSTRT_Set     ((uint32)0x00500000)
#define CR2_EXTTRIG_SWSTRT_Reset   ((uint32)0xFFAFFFFF)

/* ADC JAUTO mask */
#define CR1_JAUTO_Set              ((uint32)0x00000400)
#define CR1_JAUTO_Reset            ((uint32)0xFFFFFBFF)

/* ADC JDISCEN mask */
#define CR1_JDISCEN_Set            ((uint32)0x00001000)
#define CR1_JDISCEN_Reset          ((uint32)0xFFFFEFFF)

/* ADC JEXTSEL mask */
#define CR2_JEXTSEL_Reset          ((uint32)0xFFFF8FFF)

/* ADC JEXTTRIG mask */
#define CR2_JEXTTRIG_Set           ((uint32)0x00008000)
#define CR2_JEXTTRIG_Reset         ((uint32)0xFFFF7FFF)

/* ADC JSWSTRT mask */
#define CR2_JSWSTRT_Set            ((uint32)0x00200000)

/* ADC injected software start mask */
#define CR2_JEXTTRIG_JSWSTRT_Set   ((uint32)0x00208000)
#define CR2_JEXTTRIG_JSWSTRT_Reset ((uint32)0xFFDF7FFF)

/* ADC AWDCH mask */
#define CR1_AWDCH_Reset            ((uint32)0xFFFFFFE0)

/* ADC SQx mask */
#define SQR3_SQ_Set                ((uint8)0x1F)
#define SQR2_SQ_Set                ((uint8)0x1F)
#define SQR1_SQ_Set                ((uint8)0x1F)

/* ADC JSQx mask */
#define JSQR_JSQ_Set               ((uint8)0x1F)

/* ADC JL mask */
#define JSQR_JL_Reset              ((uint32)0xFFCFFFFF)

/* ADC SMPx mask */
#define SMPR1_SMP_Set              ((uint8)0x07)
#define SMPR2_SMP_Set              ((uint8)0x07)

/* ADC Analog watchdog enable mode mask */
#define CR1_AWDMode_Reset          ((uint32)0xFF3FFDFF)

/* ADC TSPD mask */
#define CR2_TSPD_Set               ((uint32)0x00800000)
#define CR2_TSPD_Reset             ((uint32)0xFF7FFFFF)

/* ADC JDRx registers= offset */
#define JDR_Offset                 ((uint8)0x28)

/* ADC registers Masks */
#define CR1_CLEAR_Mask             ((uint32)0xFFF0FEFF)
#define CR2_CLEAR_Mask             ((uint32)0xFFF1F7FD)
#define SQR1_CLEAR_Mask            ((uint32)0xFF0FFFFF)
...
void ADC_Init(ADC_TypeDef* ADCx, ADC_InitTypeDef* ADC_InitStruct)
{
  ...
  tmpreg1 |= (uint32)(ADC_InitStruct->ADC_Mode | ((uint32)ADC_InitStruct->ADC_ScanConvMode << 8));
  /* Write to ADCx CR1 */
  ADCx->CR1 = tmpreg1;
  ...
  tmpreg1 |= (uint32)(ADC_InitStruct->ADC_DataAlign | ADC_InitStruct->ADC_ExternalTrigConv |
            ((uint32)ADC_InitStruct->ADC_ContinuousConvMode << 1));
  /* Write to ADCx CR2 */
  ADCx->CR2 = tmpreg1;
...
* Return         : None
*******************************************************************************/
void ADC_ITConfig(ADC_TypeDef* ADCx, uint16 ADC_IT, FunctionalState NewState)
{
  uint8 itmask = 0;
...
FlagStatus ADC_GetResetCalibrationStatus(ADC_TypeDef* ADCx)
{
  ...
  if ((ADCx->CR2 & CR2_RSTCAL_Set) != (uint16)RESET)
  {
    /* RSTCAL bit is set */
    bitstatus = SET;
  }
...
FlagStatus ADC_GetCalibrationStatus(ADC_TypeDef* ADCx)
{
  ...
  if ((ADCx->CR2 & CR2_CAL_Set) != (uint16)RESET)
  {
...
FlagStatus ADC_GetSoftwareStartConvStatus(ADC_TypeDef* ADCx)
{
  ...
  if ((ADCx->CR2 & CR2_SWSTRT_Set) != (uint32)RESET)
  {
    /* SWSTRT bit is set */
    bitstatus = SET;
  }
...
* Return         : None
*******************************************************************************/
void ADC_DiscModeChannelCountConfig(ADC_TypeDef* ADCx, uint8 Number)
{
  uint32 tmpreg1 = 0;
  uint8 tmpreg2 = 0;
...
* Return         : None
*******************************************************************************/
void ADC_RegularChannelConfig(ADC_TypeDef* ADCx, uint8 ADC_Channel, uint8 Rank, uint8 ADC_SampleTime)
{
  uint32 tmpreg1 = 0, tmpreg2 = 0;
  ...
  if (ADC_Channel > ADC_Channel_9)
  {
    ...
    tmpreg2 = (uint32)SMPR1_SMP_Set << (3 * (ADC_Channel - 10));
    /* Clear the old discontinuous mode channel count */
    tmpreg1 &= ~tmpreg2;
    /* Calculate the mask to set */
    tmpreg2 = (uint32)ADC_SampleTime << (3 * (ADC_Channel - 10));
    /* Set the discontinuous mode channel count */
    tmpreg1 |= tmpreg2;
    /* Store the new register value */
    ADCx->SMPR1 = tmpreg1;
  ...
  else /* ADC_Channel include in ADC_Channel_[0..9] */
  {
    ...
    tmpreg1 = ADCx->SMPR2;
    /* Calculate the mask to clear */
    tmpreg2 = (uint32)SMPR2_SMP_Set << (3 * ADC_Channel);
    /* Clear the old discontinuous mode channel count */
    tmpreg1 &= ~tmpreg2;
    /* Calculate the mask to set */
    tmpreg2 = (uint32)ADC_SampleTime << (3 * ADC_Channel);
    /* Set the discontinuous mode channel count */
    tmpreg1 |= tmpreg2;
    /* Store the new register value */
    ADCx->SMPR2 = tmpreg1;
  ...
  if (Rank < 7)
  {
    ...
    tmpreg1 = ADCx->SQR3;
    /* Calculate the mask to clear */
    tmpreg2 = (uint32)SQR3_SQ_Set << (5 * (Rank - 1));
  ...
  else if (Rank < 13)
  {
    ...
    tmpreg1 = ADCx->SQR2;
    /* Calculate the mask to clear */
    tmpreg2 = (uint32)SQR2_SQ_Set << (5 * (Rank - 7));
    /* Clear the old SQx bits for the selected rank */
    tmpreg1 &= ~tmpreg2;
    /* Calculate the mask to set */
    tmpreg2 = (uint32)ADC_Channel << (5 * (Rank - 7));
    /* Set the SQx bits for the selected rank */
    tmpreg1 |= tmpreg2;
    /* Store the new register value */
    ADCx->SQR2 = tmpreg1;
  ...
  else
  {
    ...
    tmpreg1 = ADCx->SQR1;
    /* Calculate the mask to clear */
    tmpreg2 = (uint32)SQR1_SQ_Set << (5 * (Rank - 13));
    /* Clear the old SQx bits for the selected rank */
    tmpreg1 &= ~tmpreg2;
    /* Calculate the mask to set */
    tmpreg2 = (uint32)ADC_Channel << (5 * (Rank - 13));
    /* Set the SQx bits for the selected rank */
    tmpreg1 |= tmpreg2;
    /* Store the new register value */
    ADCx->SQR1 = tmpreg1;
...
* Return         : The Data conversion value.
*******************************************************************************/
uint32 ADC_GetDualModeConversionValue(void)
{
...
* Return         : None
*******************************************************************************/
void ADC_ExternalTrigInjectedConvConfig(ADC_TypeDef* ADCx, uint32 ADC_ExternalTrigInjecConv)
{
  uint32 tmpreg = 0;
...
FlagStatus ADC_GetSoftwareStartInjectedConvCmdStatus(ADC_TypeDef* ADCx)
{
  ...
  if ((ADCx->CR2 & CR2_JSWSTRT_Set) != (uint32)RESET)
  {
    /* JSWSTRT bit is set */
    bitstatus = SET;
  }
...
* Return         : None
*******************************************************************************/
void ADC_InjectedChannelConfig(ADC_TypeDef* ADCx, uint8 ADC_Channel, uint8 Rank, uint8 ADC_SampleTime)
{
  uint32 tmpreg1 = 0, tmpreg2 = 0;
  uint8 tmpreg3 = 0;
  ...
  tmpreg3 =  (uint8)((tmpreg1 & (uint32)~JSQR_JL_Reset)>> 20);
  /* Calculate the mask to clear: ((Rank-1)+(4-JL-1)) */
  tmpreg2 = (uint32)JSQR_JSQ_Set << (5 * ((Rank + 3) - (tmpreg3 + 1)));
  /* Clear the old JSQx bits for the selected rank */
  tmpreg1 &= ~tmpreg2;
  /* Calculate the mask to set: ((Rank-1)+(4-JL-1)) */
  tmpreg2 = (uint32)ADC_Channel << (5 * ((Rank + 3) - (tmpreg3 + 1)));
...
* Return         : None
*******************************************************************************/
void ADC_InjectedSequencerLengthConfig(ADC_TypeDef* ADCx, uint8 Length)
{
  uint32 tmpreg1 = 0;
  uint8 tmpreg2 = 0;
...
* Return         : None
*******************************************************************************/
void ADC_SetInjectedOffset(ADC_TypeDef* ADCx, uint8 ADC_InjectedChannel, uint16 Offset)
{
  /* Check the parameters */
  ...
  *((uint32 *)((*(uint32*)&ADCx) + ADC_InjectedChannel)) = (uint32)Offset;
}
...
* Return         : The Data conversion value.
*******************************************************************************/
uint16 ADC_GetInjectedConversionValue(ADC_TypeDef* ADCx, uint8 ADC_InjectedChannel)
{
  /* Check the parameters */
  ASSERT(IS_ADC_INJECTED_CHANNEL(ADC_InjectedChannel));

  /* Returns the selected injected channel conversion data value */
  return (uint16) (*(uint32*) (((*(uint32*)&ADCx) + ADC_InjectedChannel + JDR_Offset)));
}
...
* Return         : None	  
*******************************************************************************/
void ADC_AnalogWatchdogCmd(ADC_TypeDef* ADCx, uint32 ADC_AnalogWatchdog)
{
  uint32 tmpreg = 0;
...
* Return         : None
*******************************************************************************/
void ADC_AnalogWatchdogThresholdsConfig(ADC_TypeDef* ADCx, uint16 HighThreshold,
                                        uint16 LowThreshold)
{
  /* Check the parameters */
...
* Return         : None
*******************************************************************************/
void ADC_AnalogWatchdogSingleChannelConfig(ADC_TypeDef* ADCx, uint8 ADC_Channel)
{
  uint32 tmpreg = 0;
...
*******************************************************************************/
FlagStatus ADC_GetFlagStatus(ADC_TypeDef* ADCx, uint8 ADC_FLAG)
{
  FlagStatus bitstatus = RESET;
  ...
  if ((ADCx->SR & ADC_FLAG) != (uint8)RESET)
  {
    /* ADC_FLAG is set */
    bitstatus = SET;
  }
...
* Return         : None
*******************************************************************************/
void ADC_ClearFlag(ADC_TypeDef* ADCx, uint8 ADC_FLAG)
{
  /* Check the parameters */
  ASSERT(IS_ADC_CLEAR_FLAG(ADC_FLAG));

  /* Clear the selected ADC flags */
  ADCx->SR &= ~(uint32)ADC_FLAG;
}
...
*******************************************************************************/
ITStatus ADC_GetITStatus(ADC_TypeDef* ADCx, uint16 ADC_IT)
{
  ITStatus bitstatus = RESET;
  uint8 itmask = 0, enablestatus;

  /* Check the parameters */
  ASSERT(IS_ADC_GET_IT(ADC_IT));

  /* Get the ADC IT index */
  itmask = (uint8)(ADC_IT >> 8);

  /* Get the ADC_IT enable bit status */
  enablestatus = (ADCx->CR1 & (uint8)ADC_IT) ;

  /* Check the status of the specified ADC interrupt */
  if (((ADCx->SR & itmask) != (uint8)RESET) && enablestatus)
  {
    /* ADC_IT is set */
    bitstatus = SET;
  }
...
* Return         : None
*******************************************************************************/
void ADC_ClearITPendingBit(ADC_TypeDef* ADCx, uint16 ADC_IT)
{
  uint8 itmask = 0;
