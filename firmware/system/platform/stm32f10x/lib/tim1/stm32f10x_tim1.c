...
/* TIM1 CR1 Mask */
#define CR1_CounterMode_Mask                ((uint16)0x039F)
#define CR1_CKD_Mask                        ((uint16)0x00FF)

/* TIM1 CR2 Mask */
#define CR2_MMS_Mask                        ((uint16)0x0080)

/* TIM1 SMCR Mask */
#define SMCR_SMS_Mask                       ((uint16)0xFFF0)
#define SMCR_ETR_Mask                       ((uint16)0x40F7)
#define SMCR_TS_Mask                        ((uint16)0xFF87)
#define SMCR_ECE_Set                        ((uint16)0x0001)

/* TIM1 CCMRx Mask */
#define CCMR_CC13S_Mask                     ((uint16)0xFFFC)
#define CCMR_CC24S_Mask                     ((uint16)0xFCFF)
#define CCMR_TI13Direct_Set                 ((uint16)0x0001)
#define CCMR_TI24Direct_Set                 ((uint16)0x0100)
#define CCMR_OCM13_Mask                     ((uint16)0x7F0F)
#define CCMR_OCM24_Mask                     ((uint16)0x0F7F)
#define CCMR_IC13PSC_Mask                   ((uint16)0xFFF3)
#define CCMR_IC24PSC_Mask                   ((uint16)0xF3FF)
#define CCMR_IC13F_Mask                     ((uint16)0xFF0F)
#define CCMR_IC24F_Mask                     ((uint16)0x0FFF)
#define OC13Mode_Mask		                ((uint16)0xFF00)
#define OC24Mode_Mask		                ((uint16)0x00FF)

/* TIM1 CCER Set/Reset Bit */
#define CCER_CCE_Set                        ((uint16)0x0001)
#define CCER_CCE_Reset                      ((uint16)0x0000)

/* TIM1 DMA Mask */
#define DCR_DMA_Mask                        ((uint16)0x0000)

/* TIM1 private Masks */
#define TIM1_Period_Reset_Mask               ((uint16)0xFFFF)
#define TIM1_Prescaler_Reset_Mask            ((uint16)0x0000)
#define TIM1_RepetitionCounter_Reset_Mask    ((uint16)0x0000)
#define TIM1_Pulse_Reset_Mask                ((uint16)0x0000)
...
static void ETR_Config(uint16 TIM1_ExtTRGPrescaler, uint16 TIM1_ExtTRGPolarity,
                       uint16 ExtTRGFilter);
static void TI1_Config(uint16 TIM1_ICPolarity, uint16 TIM1_ICSelection,
                       uint8 TIM1_ICFilter);
static void TI2_Config(uint16 TIM1_ICPolarity, uint16 TIM1_ICSelection,
                       uint8 TIM1_ICFilter);
static void TI3_Config(uint16 TIM1_ICPolarity, uint16 TIM1_ICSelection,
                       uint8 TIM1_ICFilter);
...
void TIM1_TimeBaseInit(TIM1_TimeBaseInitTypeDef* TIM1_TimeBaseInitStruct)
{
 /* Check the parameters */
  ...
  TIM1->CR1 |= (uint32)TIM1_TimeBaseInitStruct->TIM1_ClockDivision |
...
void TIM1_OC1Init(TIM1_OCInitTypeDef* TIM1_OCInitStruct)
{
  ...
  *(vuint32 *) CCER_CC1E_BB = CCER_CCE_Reset;
  ...
  *(vuint32 *) CCER_CC1E_BB = TIM1_OCInitStruct->TIM1_OutputState;

  /* Set the Output N State */
  *(vuint32 *) CCER_CC1NE_BB = TIM1_OCInitStruct->TIM1_OutputNState;

  /* Set the Output Polarity */
  *(vuint32 *) CCER_CC1P_BB = TIM1_OCInitStruct->TIM1_OCPolarity;

  /* Set the Output N Polarity */
  *(vuint32 *) CCER_CC1NP_BB = TIM1_OCInitStruct->TIM1_OCNPolarity;

  /* Set the Output Idle state */
  *(vuint32 *) CR2_OIS1_BB = TIM1_OCInitStruct->TIM1_OCIdleState;

  /* Set the Output N Idle state */
  *(vuint32 *) CR2_OIS1N_BB = TIM1_OCInitStruct->TIM1_OCNIdleState;
...
void TIM1_OC2Init(TIM1_OCInitTypeDef* TIM1_OCInitStruct)
{
  ...
  *(vuint32 *) CCER_CC2E_BB = CCER_CCE_Reset;

  /* Reset the Output Compare Bits */
   tmpccmr &= OC24Mode_Mask;

  /* Set the Ouput Compare Mode */
  tmpccmr |= (uint32)TIM1_OCInitStruct->TIM1_OCMode << 8;

  TIM1->CCMR1 = (uint16)tmpccmr;

  /* Set the Output State */
  *(vuint32 *) CCER_CC2E_BB = TIM1_OCInitStruct->TIM1_OutputState;

  /* Set the Output N State */
  *(vuint32 *) CCER_CC2NE_BB = TIM1_OCInitStruct->TIM1_OutputNState;

  /* Set the Output Polarity */
  *(vuint32 *) CCER_CC2P_BB = TIM1_OCInitStruct->TIM1_OCPolarity;

  /* Set the Output N Polarity */
  *(vuint32 *) CCER_CC2NP_BB = TIM1_OCInitStruct->TIM1_OCNPolarity;

  /* Set the Output Idle state */
  *(vuint32 *) CR2_OIS2_BB = TIM1_OCInitStruct->TIM1_OCIdleState;

  /* Set the Output N Idle state */
  *(vuint32 *) CR2_OIS2N_BB = TIM1_OCInitStruct->TIM1_OCNIdleState;
...
void TIM1_OC3Init(TIM1_OCInitTypeDef* TIM1_OCInitStruct)
{
  ...
  *(vuint32 *) CCER_CC3E_BB = CCER_CCE_Reset;
  ...
  /* Set the Output State */
  *(vuint32 *) CCER_CC3E_BB = TIM1_OCInitStruct->TIM1_OutputState;

  /* Set the Output N State */
  *(vuint32 *) CCER_CC3NE_BB = TIM1_OCInitStruct->TIM1_OutputNState;

  /* Set the Output Polarity */
  *(vuint32 *) CCER_CC3P_BB = TIM1_OCInitStruct->TIM1_OCPolarity;

  /* Set the Output N Polarity */
  *(vuint32 *) CCER_CC3NP_BB = TIM1_OCInitStruct->TIM1_OCNPolarity;

  /* Set the Output Idle state */
  *(vuint32 *) CR2_OIS3_BB = TIM1_OCInitStruct->TIM1_OCIdleState;

  /* Set the Output N Idle state */
  *(vuint32 *) CR2_OIS3N_BB = TIM1_OCInitStruct->TIM1_OCNIdleState;
...
void TIM1_OC4Init(TIM1_OCInitTypeDef* TIM1_OCInitStruct)
{
  ...
  *(vuint32 *) CCER_CC4E_BB = CCER_CCE_Reset;
  ...
  TIM1->CCMR2 = (uint16)tmpccmr;

  /* Set the Output State */
  *(vuint32 *) CCER_CC4E_BB = TIM1_OCInitStruct->TIM1_OutputState;

  /* Set the Output Polarity */
  *(vuint32 *) CCER_CC4P_BB = TIM1_OCInitStruct->TIM1_OCPolarity;

  /* Set the Output Idle state */
  *(vuint32 *) CR2_OIS4_BB = TIM1_OCInitStruct->TIM1_OCIdleState;
...
void TIM1_BDTRConfig(TIM1_BDTRInitTypeDef *TIM1_BDTRInitStruct)
{
  ...
  tmpbdtr = (uint32)TIM1_BDTRInitStruct->TIM1_OSSRState | TIM1_BDTRInitStruct->TIM1_OSSIState |
...
{
  uint8 ICPolarity = TIM1_ICPolarity_Rising;
  uint8 ICSelection = TIM1_ICSelection_DirectTI;
...
void TIM1_Cmd(FunctionalState NewState)
{
  ...
  *(vuint32 *) CR1_CEN_BB = (uint16)NewState;
}
...
void TIM1_CtrlPWMOutputs(FunctionalState Newstate)
{
  ...
  *(vuint32 *) BDTR_MOE_BB = (uint16)Newstate;
}
...
void TIM1_DMACmd(uint16 TIM1_DMASource, FunctionalState Newstate)
{
  ...
  else
  {
    ...
    tmpdier &= (uint16)~TIM1_DMASource;
  }
  TIM1->DIER = (uint16)tmpdier;
}
                             ...
                             uint16 ExtTRGFilter)
{
  ...
  *(vuint32 *) SMCR_ECE_BB = SMCR_ECE_Set;
}
...
* Return         : None
*******************************************************************************/
void TIM1_TIxExternalClockConfig(uint16 TIM1_TIxExternalCLKSource,
                                uint16 TIM1_ICPolarity, uint8 ICFilter)
{
  /* Check the parameters */
...
void TIM1_UpdateDisableConfig(FunctionalState Newstate)
{
  ...
  *(vuint32 *) CR1_UDIS_BB = (uint16)Newstate;
}
...
void TIM1_UpdateRequestConfig(uint8 TIM1_UpdateSource)
{
  ...
  *(vuint32 *) CR1_URS_BB = TIM1_UpdateSource;
}
...
void TIM1_SelectHallSensor(FunctionalState Newstate)
{
  ...
  *(vuint32 *) CR2_TI1S_BB = (uint16)Newstate;
}
...
void TIM1_SelectOnePulseMode(uint16 TIM1_OPMode)
{
  ...
  *(vuint32 *) CR1_OPM_BB = TIM1_OPMode;
}
...
void TIM1_SelectMasterSlaveMode(uint16 TIM1_MasterSlaveMode)
{
  ...
  *(vuint32 *) SMCR_MSM_BB = TIM1_MasterSlaveMode;
}
                                ...
                                uint16 TIM1_IC2Polarity)
{
  ...
  *(vuint32 *) CCER_CC1P_BB = TIM1_IC1Polarity;
  *(vuint32 *) CCER_CC2P_BB = TIM1_IC2Polarity;

  TIM1->SMCR = (uint16)tmpsmcr;

  TIM1->CCMR1 = (uint16)tmpccmr1;
}
...
void TIM1_PrescalerConfig(uint16 Prescaler, uint16 TIM1_PSCReloadMode)
{
  ...
  *(vuint32 *) EGR_UG_BB = TIM1_PSCReloadMode;
}
/*******************************************************************************
...
void TIM1_ForcedOC2Config(uint16 TIM1_ForcedAction)
{
  ...
  /* Configure The Forced output Mode */
  tmpccmr1 |= (uint32)TIM1_ForcedAction << 8;
...
void TIM1_ForcedOC4Config(uint16 TIM1_ForcedAction)
{
  ...
  /* Configure The Forced output Mode */
  tmpccmr2 |= (uint16)((uint16)TIM1_ForcedAction << 8);
...
void TIM1_ARRPreloadConfig(FunctionalState Newstate)
{
  ...
  *(vuint32 *) CR1_ARPE_BB = (uint16)Newstate;
}
...
void TIM1_SelectCOM(FunctionalState Newstate)
{
  ...
  *(vuint32 *) CR2_CCUS_BB = (uint16)Newstate;
}
...
void TIM1_SelectCCDMA(FunctionalState Newstate)
{
  ...
  *(vuint32 *) CR2_CCDS_BB = (uint16)Newstate;
}
...
void TIM1_CCPreloadControl(FunctionalState Newstate)
{
  ...
  *(vuint32 *) CR2_CCPC_BB = (uint16)Newstate;
}
...
void TIM1_OC1PreloadConfig(uint16 TIM1_OCPreload)
{
  ...
  *(vuint32 *) CCMR1_OC1PE_BB = (uint16)TIM1_OCPreload;
}
...
void TIM1_OC2PreloadConfig(uint16 TIM1_OCPreload)
{
  ...
  *(vuint32 *) CCMR1_OC2PE_BB = (uint16)TIM1_OCPreload;
}
...
void TIM1_OC3PreloadConfig(uint16 TIM1_OCPreload)
{
  ...
  *(vuint32 *) CCMR2_OC3PE_BB = (uint16)TIM1_OCPreload;
}
...
void TIM1_OC4PreloadConfig(uint16 TIM1_OCPreload)
{
  ...
  *(vuint32 *) CCMR2_OC4PE_BB = (uint16)TIM1_OCPreload;
}
...
void TIM1_OC1FastConfig(uint16 TIM1_OCFast)
{
  ...
  *(vuint32 *) CCMR1_OC1FE_BB = (uint16)TIM1_OCFast;
}
...
void TIM1_OC2FastConfig(uint16 TIM1_OCFast)
{
  ...
  *(vuint32 *) CCMR1_OC2FE_BB = (uint16)TIM1_OCFast;
}
...
void TIM1_OC3FastConfig(uint16 TIM1_OCFast)
{
  ...
  *(vuint32 *) CCMR2_OC3FE_BB = (uint16)TIM1_OCFast;
}
...
void TIM1_OC4FastConfig(uint16 TIM1_OCFast)
{
  ...
  *(vuint32 *) CCMR2_OC4FE_BB = (uint16)TIM1_OCFast;
}
...
void TIM1_OC1PolarityConfig(uint16 TIM1_OCPolarity)
{
  ...
  *(vuint32 *) CCER_CC1P_BB = (uint16)TIM1_OCPolarity;
}
...
void TIM1_OC1NPolarityConfig(uint16 TIM1_OCPolarity)
{
  ...
  *(vuint32 *) CCER_CC1NP_BB = (uint16)TIM1_OCPolarity;
}
...
void TIM1_OC2PolarityConfig(uint16 TIM1_OCPolarity)
{
  ...
  *(vuint32 *) CCER_CC2P_BB = (uint16)TIM1_OCPolarity;
}
...
void TIM1_OC2NPolarityConfig(uint16 TIM1_OCPolarity)
{
  ...
  /* Set or Reset the CC3P Bit */
  *(vuint32 *) CCER_CC2NP_BB = (uint16)TIM1_OCPolarity;
}
...
void TIM1_OC3PolarityConfig(uint16 TIM1_OCPolarity)
{
  ...
  /* Set or Reset the CC3P Bit */
  *(vuint32 *) CCER_CC3P_BB = (uint16)TIM1_OCPolarity;
}
...
void TIM1_OC3NPolarityConfig(uint16 TIM1_OCPolarity)
{
  ...
  /* Set or Reset the CC3P Bit */
  *(vuint32 *) CCER_CC3NP_BB = (uint16)TIM1_OCPolarity;
}
...
void TIM1_OC4PolarityConfig(uint16 TIM1_OCPolarity)
{
  ...
  *(vuint32 *) CCER_CC4P_BB = (uint16)TIM1_OCPolarity;
}
...
void TIM1_CCxNCmd(uint16 TIM1_Channel, FunctionalState Newstate)
{
  ...
  if(TIM1_Channel == TIM1_Channel_1)
  {
    ...
    *(vuint32 *) CCER_CC1NE_BB = (uint16)Newstate;  
  }
  else if(TIM1_Channel == TIM1_Channel_2)
  {
    /* Set or Reset the CC2NE Bit */
    *(vuint32 *) CCER_CC2NE_BB = (uint16)Newstate;
  }
  else 
  {
    /* Set or Reset the CC3NE Bit */
    *(vuint32 *) CCER_CC3NE_BB = (uint16)Newstate;
  }
}
...
void TIM1_SelectOCxM(uint16 TIM1_Channel, uint16 TIM1_OCMode)
{
  ...
  else if(TIM1_Channel == TIM1_Channel_2)
  {
    ...
    *(vuint32 *) CCER_CC2E_BB = CCER_CCE_Reset;
    ...
    /* Set the Ouput Compare Mode */
    TIM1->CCMR1 |= (uint16)((uint16)TIM1_OCMode << 8);
  }
  else if(TIM1_Channel == TIM1_Channel_3)
  {
    /* Disable the Channel 3: Reset the CCE Bit */
  ...
  else
  {
    ...
    *(vuint32 *) CCER_CC4E_BB = CCER_CCE_Reset;
    ...
    /* Set the Ouput Compare Mode */
    TIM1->CCMR2 |= (uint16)((uint16)TIM1_OCMode << 8);
  }
}
...
void TIM1_SetIC2Prescaler(uint16 TIM1_IC2Prescaler)
{
  ...
  tmpccmr1 |= (uint16)((uint16)TIM1_IC2Prescaler << 8);
...
void TIM1_SetIC4Prescaler(uint16 TIM1_IC4Prescaler)
{
  ...
  tmpccmr2 |= (uint16)((uint16)TIM1_IC4Prescaler << 8);
...
FlagStatus TIM1_GetFlagStatus(uint16 TIM1_FLAG)
{
  ...
  if ((TIM1->SR & TIM1_FLAG) != (uint16)RESET )
  {
    bitstatus = SET;
  }
  else
...
ITStatus TIM1_GetITStatus(uint16 TIM1_IT)
{
  ...
  uint16 TIM1_itStatus = 0x0, TIM1_itEnable = 0x0;
  ...
  if ((TIM1_itStatus != (uint16)RESET ) && (TIM1_itEnable != (uint16)RESET ))
  {
    bitstatus = SET;
  }
  else
                       ...
                       uint8 TIM1_ICFilter)
{
  ...
  *(vuint32 *) CCER_CC1E_BB = CCER_CCE_Reset;
  ...
  tmpccmr1 |= (uint16)TIM1_ICSelection | (uint16)((uint16)TIM1_ICFilter << 4);

  TIM1->CCMR1 = (uint16)tmpccmr1;

  /* Select the Polarity */
  *(vuint32 *) CCER_CC1P_BB = TIM1_ICPolarity;

  /* Set the CCE Bit */
  *(vuint32 *) CCER_CC1E_BB = CCER_CCE_Set;
}
                       ...
                       uint8 TIM1_ICFilter)
{
  ...
  *(vuint32 *) CCER_CC2E_BB = CCER_CCE_Reset;
  ...
  tmpccmr1 |= (uint16)((uint16)TIM1_ICSelection << 8) | (uint16)((uint16)TIM1_ICFilter <<12);

  TIM1->CCMR1 = (uint16)tmpccmr1;

  /* Select the Polarity */
  *(vuint32 *) CCER_CC2P_BB = TIM1_ICPolarity;

  /* Set the CCE Bit */
  *(vuint32 *) CCER_CC2E_BB = CCER_CCE_Set;
                       ...
                       uint8 TIM1_ICFilter)
{
  ...
  *(vuint32 *) CCER_CC3E_BB = CCER_CCE_Reset;
  ...
  tmpccmr2 |= (uint16)TIM1_ICSelection | (uint16)((uint16)TIM1_ICFilter << 4);

  TIM1->CCMR2 = (uint16)tmpccmr2;

  /* Select the Polarity */
  *(vuint32 *) CCER_CC3P_BB = TIM1_ICPolarity;

  /* Set the CCE Bit */
  *(vuint32 *) CCER_CC3E_BB = CCER_CCE_Set;
}
                       ...
                       uint8 TIM1_ICFilter)
{
  ...
  *(vuint32 *) CCER_CC4E_BB = CCER_CCE_Reset;
  ...
  tmpccmr2 |= (uint16)((uint16)TIM1_ICSelection << 8) | (uint16)((uint16)TIM1_ICFilter << 12);

  TIM1->CCMR2 = (uint16)tmpccmr2;

  /* Select the Polarity */
  *(vuint32 *) CCER_CC4P_BB = TIM1_ICPolarity;

  /* Set the CCE Bit */
  *(vuint32 *) CCER_CC4E_BB = CCER_CCE_Set;
}
                       ...
                       uint16 ExtTRGFilter)
{
  ...
  tmpsmcr |= TIM1_ExtTRGPrescaler | TIM1_ExtTRGPolarity | (uint16)((uint16)ExtTRGFilter << 8);
