...
#define SysTick_CLKSource_HCLK_Div8    ((uint32)0xFFFFFFFB)
#define SysTick_CLKSource_HCLK         ((uint32)0x00000004)
...
/* SysTick Flag */
#define SysTick_FLAG_COUNT             ((uint8)0x30)
#define SysTick_FLAG_SKEW              ((uint8)0x5E)
#define SysTick_FLAG_NOREF             ((uint8)0x5F)
...
/* Exported macro ------------------------------------------------------------*/
/* Exported functions ------------------------------------------------------- */
void SysTick_CLKSourceConfig(uint32 SysTick_CLKSource);
void SysTick_SetReload(uint32 Reload);
void SysTick_CounterCmd(uint32 SysTick_Counter);
void SysTick_ITConfig(FunctionalState NewState);
uint32 SysTick_GetCounter(void);
FlagStatus SysTick_GetFlagStatus(uint8 SysTick_FLAG);
