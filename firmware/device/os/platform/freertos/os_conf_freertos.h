...
#ifndef _OS_CONF_FREERTOS_H_
#define _OS_CONF_FREERTOS_H_
...
#define configCPU_CLOCK_HZ			(DEVICE_CLOCK_RATE)
...
#define configMAX_TASK_NAME_LEN		(OS_TASK_NAME_LEN)
...
#define configTIMER_TASK_PRIORITY		(OS_MAX_PRIORITIES-1)
