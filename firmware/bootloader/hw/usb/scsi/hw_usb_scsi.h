 ...
 *
 */
#ifndef _HW_USB_SCSI_H_
#define _HW_USB_SCSI_H_
...
------------------------------------------------------------------------------*/
extern  uint8 Page00_Inquiry_Data[];
extern  uint8 Standard_Inquiry_Data[];
extern  uint8 Standard_Inquiry_Data2[];
extern  uint8 Mode_Sense6_data[];
extern  uint8 Mode_Sense10_data[];
extern  uint8 Scsi_Sense_Data[];
extern  uint8 SCSI_ReadCapacity[];
extern  uint8 SCSI_ReadFormatCapacity [];


#endif /* _HW_USB_SCSI_H_ */
