/*!
 * \file hw_usb_mass_storage_prop.c
 *
 * \brief 
 *
 *
...
#include "hw_usb_mass_storage_prop.h"
#include "hw/usb/desc/hw_usb_desc_mass_storage.h"
#include "hw/usb/scsi/hw_usb_scsi.h"
#include "hw/usb/bot/hw_usb_bot.h"
#include "hw/usb/pwr/hw_usb_pwr.h"
...
ONE_DESCRIPTOR Device_Descriptor =
  {
    (uint8*)MASS_DeviceDescriptor,
    MASS_SIZ_DEVICE_DESC
  };

ONE_DESCRIPTOR Config_Descriptor =
  {
    (uint8*)MASS_ConfigDescriptor,
    MASS_SIZ_CONFIG_DESC
  };

ONE_DESCRIPTOR String_Descriptor[5] =
  {
    {(uint8*)MASS_StringLangID, MASS_SIZ_STRING_LANGID},
    {(uint8*)MASS_StringVendor, MASS_SIZ_STRING_VENDOR},
    {(uint8*)MASS_StringProduct, MASS_SIZ_STRING_PRODUCT},
    {(uint8*)MASS_StringSerial, MASS_SIZ_STRING_SERIAL},
    {(uint8*)MASS_StringInterface, MASS_SIZ_STRING_INTERFACE},
  };
...
* Return         : RESULT.
*******************************************************************************/
USB_RESULT MASS_Data_Setup(uint8 RequestNo)
{
...
* Return         : RESULT.
*******************************************************************************/
USB_RESULT MASS_NoData_Setup(uint8 RequestNo)
{
  if ((Type_Recipient == (CLASS_REQUEST | INTERFACE_RECIPIENT))
...
*                  supported one.
* Input          : uint8 Interface, uint8 AlternateSetting.
* Output         : None.
* Return         : RESULT.
*******************************************************************************/
...
* Return         : None.
*******************************************************************************/
uint8 *MASS_GetDeviceDescriptor(uint16 Length)
{
...
* Return         : None.
*******************************************************************************/
uint8 *MASS_GetConfigDescriptor(uint16 Length)
{
...
* Return         : None.
*******************************************************************************/
uint8 *MASS_GetStringDescriptor(uint16 Length)
{
...
void Get_SerialNum(void)
{
  ...
  Device_Serial0 = *(__IO uint32*)(0x1FFFF7E8);
  Device_Serial1 = *(__IO uint32*)(0x1FFFF7EC);
  Device_Serial2 = *(__IO uint32*)(0x1FFFF7F0);
