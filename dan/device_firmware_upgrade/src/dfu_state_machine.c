...
static State stateTable[] =
{
		...
		{ DFU_CMD_INITIALIZE_UPDATE, 			DFU_CMD_QUERY_DEVICE, 				DFU_STATE_NULL, 					dfu_ActionInitializeUpdate 					},

		// Update Sequence
		{ DFU_CMD_BEGIN_UPDATE, 				DFU_CMD_QUERY_DEVICE, 	            DFU_STATE_BEGIN_UPDATE, 			dfu_ActionBeginUpdate 						},
		...
		{ DFU_CMD_SECTION_VALIDATE,             DFU_STATE_START_SECTION_VALIDATION, DFU_STATE_VALIDATE_SECTION,         dfu_ActionSectionValidate        	        },
		{ DFU_CMD_SECTION_VALIDATE,             DFU_STATE_VALIDATE_SECTION,         DFU_STATE_VALIDATE_SECTION,         dfu_ActionSectionValidate        	        },
