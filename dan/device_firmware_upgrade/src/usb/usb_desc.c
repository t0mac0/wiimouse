...
const uint8 Virtual_Com_Port_DeviceDescriptor[VIRTUAL_COM_PORT_SIZ_DEVICE_DESC] =
  {
    0x12,   /* bLength */
    ...
    0x6D,
    0xF4,   /* idVendor = 0xF46D */
    0x2B,
    0xF5,   /* idProduct = 0xF52B */
    0xF0,
    0x00,   /* bcdDevice = 0xF000 */
...
const uint8 Virtual_Com_Port_ConfigDescriptor[VIRTUAL_COM_PORT_SIZ_CONFIG_DESC] =
  {
