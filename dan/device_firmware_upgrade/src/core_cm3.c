...
// */
//__ASM uint32 __REVSH(uint16 value)
//{
//  revsh r0, r0
//  bx lr
//}
 ...
 * Return the actual process stack pointer
 */
uint32 __get_PSP(void) __attribute__( ( naked ) );
uint32 __get_PSP(void)
{
  uint32 result=0;
 ...
 * (process stack pointer) Cortex processor register
 */
void __set_PSP(uint32 topOfProcStack) __attribute__( ( naked ) );
void __set_PSP(uint32 topOfProcStack)
{
 ...
 * Cortex processor register
 */
uint32 __get_MSP(void) __attribute__( ( naked ) );
uint32 __get_MSP(void)
{
  uint32 result=0;
 ...
 * (main stack pointer) Cortex processor register
 */
void __set_MSP(uint32 topOfMainStack) __attribute__( ( naked ) );
void __set_MSP(uint32 topOfMainStack)
{
