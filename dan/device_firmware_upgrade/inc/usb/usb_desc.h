...
#define USB_PRODUCT_ID 0xF52B
#define USB_DEVICE_ID 0xF000
...
#define VIRTUAL_COM_PORT_SIZ_CONFIG_DESC        (67+8)
...
/* Exported functions ------------------------------------------------------- */
extern const uint8 Virtual_Com_Port_DeviceDescriptor[VIRTUAL_COM_PORT_SIZ_DEVICE_DESC];
extern const uint8 Virtual_Com_Port_ConfigDescriptor[VIRTUAL_COM_PORT_SIZ_CONFIG_DESC];
