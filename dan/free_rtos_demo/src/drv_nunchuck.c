...
/*-------------------------------------------------------------------------------
	Class Constants
--------------------------------------------------------------------------------*/
u8 REQUEST_PCKT[] = { NUNCHUCK_ADDR, NUNCHUCK_ZERO };
...
/*-------------------------------------------------------------------------------
	Class data members
--------------------------------------------------------------------------------*/
u8 nunchuck_buffer[DATA_PCKT_LEN];
...
void nunchuck_get_accelerometer( u16 *x_val, u16 *y_val, u16 *z_val ){
	*x_val = ((u16)nunchuck_buffer[2] << 2) | ((u16)nunchuck_buffer[5] & 0x0C);
	*y_val = ((u16)nunchuck_buffer[3] << 2) | ((u16)nunchuck_buffer[5] & 0x30);
	*z_val = ((u16)nunchuck_buffer[4] << 2) | ((u16)nunchuck_buffer[5] & 0xC0);
}
