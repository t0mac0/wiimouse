...
#define GPIO_Remap1_CAN1            ((uint32)0x001D4000)  /*!< CAN1 Alternate Function mapping */
#define GPIO_Remap2_CAN1            ((uint32)0x001D6000)  /*!< CAN1 Alternate Function mapping */
...
#define GPIO_Remap_TIM13            ((uint32)0x80000100)  /*!< TIM13 Alternate Function mapping (only for High density Value line and XL-density devices) */
#define GPIO_Remap_TIM14            ((uint32)0x80000200)  /*!< TIM14 Alternate Function mapping (only for High density Value line and XL-density devices) */
#define GPIO_Remap_FSMC_NADV        ((uint32)0x80000400)  /*!< FSMC_NADV Alternate Function mapping (only for High density Value line and XL-density devices) */

#define GPIO_Remap_TIM67_DAC_DMA    ((uint32)0x80000800)  /*!< TIM6/TIM7 and DAC DMA requests remapping (only for High density Value line devices) */
#define GPIO_Remap_TIM12            ((uint32)0x80001000)  /*!< TIM12 Alternate Function mapping (only for High density Value line devices) */
#define GPIO_Remap_MISC             ((uint32)0x80002000)  /*!< Miscellaneous Remap (DMA2 Channel5 Position and DAC Trigger remapping,
...
#define GPIO_PortSourceGPIOA       ((uint8)0x00)
#define GPIO_PortSourceGPIOB       ((uint8)0x01)
#define GPIO_PortSourceGPIOC       ((uint8)0x02)
#define GPIO_PortSourceGPIOD       ((uint8)0x03)
#define GPIO_PortSourceGPIOE       ((uint8)0x04)
#define GPIO_PortSourceGPIOF       ((uint8)0x05)
#define GPIO_PortSourceGPIOG       ((uint8)0x06)
...
uint16 GPIO_ReadInputData(GPIO_TypeDef* GPIOx);
uint8 GPIO_ReadOutputDataBit(GPIO_TypeDef* GPIOx, uint16 GPIO_Pin);
uint16 GPIO_ReadOutputData(GPIO_TypeDef* GPIOx);
void GPIO_SetBits(GPIO_TypeDef* GPIOx, uint16 GPIO_Pin);
void GPIO_ResetBits(GPIO_TypeDef* GPIOx, uint16 GPIO_Pin);
void GPIO_WriteBit(GPIO_TypeDef* GPIOx, uint16 GPIO_Pin, BitAction BitVal);
void GPIO_Write(GPIO_TypeDef* GPIOx, uint16 PortVal);
void GPIO_PinLockConfig(GPIO_TypeDef* GPIOx, uint16 GPIO_Pin);
void GPIO_EventOutputConfig(uint8 GPIO_PortSource, uint8 GPIO_PinSource);
void GPIO_EventOutputCmd(FunctionalState NewState);
void GPIO_PinRemapConfig(uint32 GPIO_Remap, FunctionalState NewState);
void GPIO_EXTILineConfig(uint8 GPIO_PortSource, uint8 GPIO_PinSource);
void GPIO_ETH_MediaInterfaceConfig(uint32 GPIO_ETH_MediaInterface);
