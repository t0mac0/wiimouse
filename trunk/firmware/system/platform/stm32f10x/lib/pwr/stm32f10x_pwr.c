...
#define CR_PDDS_Set              ((uint32)0x00000002)
#define CR_DS_Mask               ((uint32)0xFFFFFFFC)
#define CR_CWUF_Set              ((uint32)0x00000004)
#define CR_PLS_Mask              ((uint32)0xFFFFFF1F)

/* --------- Cortex System Control register bit mask ---------------- */
/* Cortex System Control register address */
#define SCB_SysCtrl              ((uint32)0xE000ED10)
/* SLEEPDEEP bit mask */
#define SysCtrl_SLEEPDEEP_Set    ((uint32)0x00000004)
...
void PWR_BackupAccessCmd(FunctionalState NewState)
{
  ...
  *(vuint32 *) CR_DBP_BB = (uint32)NewState;
}
...
void PWR_PVDCmd(FunctionalState NewState)
{
  ...
  *(vuint32 *) CR_PVDE_BB = (uint32)NewState;
}
...
void PWR_WakeUpPinCmd(FunctionalState NewState)
{
  ...
  *(vuint32 *) CSR_EWUP_BB = (uint32)NewState;
}
...
void PWR_EnterSTOPMode(uint32 PWR_Regulator, uint8 PWR_STOPEntry)
{
  ...
  *(vuint32 *) SCB_SysCtrl |= SysCtrl_SLEEPDEEP_Set;
...
FlagStatus PWR_GetFlagStatus(uint32 PWR_FLAG)
{
  ...
  if ((PWR->CSR & PWR_FLAG) != (uint32)RESET)
  {
    bitstatus = SET;
  }
  else
