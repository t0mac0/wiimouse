...
#define RTCCR_CAL_Mask    ((uint16)0xFF80)

/* CSR register bit mask */
#define CSR_CTE_Set       ((uint16)0x0001)
#define CSR_CTI_Set       ((uint16)0x0002)
...
void BKP_TamperPinCmd(FunctionalState NewState)
{
  ...
  *(vuint32 *) CR_TPE_BB = (uint32)NewState;
}
...
void BKP_ITConfig(FunctionalState NewState)
{
  ...
  *(vuint32 *) CSR_TPIE_BB = (uint32)NewState;
}
...
void BKP_RTCCalibrationClockOutputCmd(FunctionalState NewState)
{
  ...
  *(vuint32 *) RTCCR_CCO_BB = (uint32)NewState;
}
...
{
  return (FlagStatus)(*(vuint32 *) CSR_TEF_BB);
}
...
{
  return (ITStatus)(*(vuint32 *) CSR_TIF_BB);
}
