...
#define CR_WDGA_Set       ((uint32)0x00000080)

/* CFR register bit mask */
#define CFR_WDGTB_Mask    ((uint32)0xFFFFFE7F)
#define CFR_W_Mask        ((uint32)0xFFFFFF80)

#define BIT_Mask          ((uint8)0x7F)
...
* Return         : None
*******************************************************************************/
void WWDG_SetPrescaler(uint32 WWDG_Prescaler)
{
  uint32 tmpreg = 0;
...
* Return         : None
*******************************************************************************/
void WWDG_SetWindowValue(uint8 WindowValue)
{
  uint32 tmpreg = 0;
...
{
  *(vuint32 *) CFR_EWI_BB = (uint32)ENABLE;
}
...
* Return         : None
*******************************************************************************/
void WWDG_Enable(uint8 Counter)
{
  /* Check the parameters */
  ASSERT(IS_WWDG_COUNTER(Counter));
...
{
  return (FlagStatus)(*(vuint32 *) SR_EWIF_BB);
}
