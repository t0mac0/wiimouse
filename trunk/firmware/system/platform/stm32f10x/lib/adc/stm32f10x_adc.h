...
#define ADC_ExternalTrigConv_Ext_IT11              ((uint32)0x000C0000)
...
#define ADC_ExternalTrigInjecConv_T1_TRGO          ((uint32)0x00000000)
#define ADC_ExternalTrigInjecConv_T1_CC4           ((uint32)0x00001000)
#define ADC_ExternalTrigInjecConv_T2_TRGO          ((uint32)0x00002000)
#define ADC_ExternalTrigInjecConv_T2_CC1           ((uint32)0x00003000)
#define ADC_ExternalTrigInjecConv_T3_CC4           ((uint32)0x00004000)
#define ADC_ExternalTrigInjecConv_T4_TRGO          ((uint32)0x00005000)
#define ADC_ExternalTrigInjecConv_Ext_IT15         ((uint32)0x00006000)
#define ADC_ExternalTrigInjecConv_None             ((uint32)0x00007000)
...
#define ADC_InjectedChannel_1                       ((uint8)0x14)
#define ADC_InjectedChannel_2                       ((uint8)0x18)
#define ADC_InjectedChannel_3                       ((uint8)0x1C)
#define ADC_InjectedChannel_4                       ((uint8)0x20)
...
#define ADC_AnalogWatchdog_SingleRegEnable         ((uint32)0x00800200)
#define ADC_AnalogWatchdog_SingleInjecEnable       ((uint32)0x00400200)
#define ADC_AnalogWatchdog_SingleRegOrInjecEnable  ((uint32)0x00C00200)
#define ADC_AnalogWatchdog_AllRegEnable            ((uint32)0x00800000)
#define ADC_AnalogWatchdog_AllInjecEnable          ((uint32)0x00400000)
#define ADC_AnalogWatchdog_AllRegAllInjecEnable    ((uint32)0x00C00000)
#define ADC_AnalogWatchdog_None                    ((uint32)0x00000000)
...
#define ADC_IT_EOC                                 ((uint16)0x0220)
#define ADC_IT_AWD                                 ((uint16)0x0140)
#define ADC_IT_JEOC                                ((uint16)0x0480)

#define IS_ADC_IT(IT) (((IT & (uint16)0xF81F) == 0x00) && (IT != 0x00))
...
#define IS_ADC_CLEAR_FLAG(FLAG) (((FLAG & (uint8)0xE0) == 0x00) && (FLAG != 0x00))
...
void ADC_AnalogWatchdogThresholdsConfig(ADC_TypeDef* ADCx, uint16 HighThreshold, uint16 LowThreshold);
