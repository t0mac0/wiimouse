...
#define CR1_CEN_Set                 ((uint16)0x0001)
#define CR1_CEN_Reset               ((uint16)0x03FE)
#define CR1_UDIS_Set                ((uint16)0x0002)
#define CR1_UDIS_Reset              ((uint16)0x03FD)
#define CR1_URS_Set                 ((uint16)0x0004)
#define CR1_URS_Reset               ((uint16)0x03FB)
#define CR1_OPM_Mask                ((uint16)0x03F7)
#define CR1_CounterMode_Mask        ((uint16)0x039F)
#define CR1_ARPE_Set                ((uint16)0x0080)
#define CR1_ARPE_Reset              ((uint16)0x037F)
#define CR1_CKD_Mask                ((uint16)0x00FF)

#define CR2_CCDS_Set                ((uint16)0x0008)
#define CR2_CCDS_Reset              ((uint16)0x0007)
#define CR2_MMS_Mask                ((uint16)0x0080)
#define CR2_TI1S_Set                ((uint16)0x0080)
#define CR2_TI1S_Reset              ((uint16)0xFF70)

#define SMCR_SMS_Mask               ((uint16)0xFFF0)
#define SMCR_ETR_Mask               ((uint16)0x00F7)
#define SMCR_TS_Mask                ((uint16)0xFF87)
#define SMCR_MSM_Mask               ((uint16)0xFF77)
#define SMCR_ECE_Set                ((uint16)0x4000)

#define CCMR_CC13S_Mask             ((uint16)0x7F7C)
#define CCMR_CC24S_Mask             ((uint16)0x7C7F)
#define CCMR_TI13Direct_Set         ((uint16)0x0001)
#define CCMR_TI24Direct_Set         ((uint16)0x0100)
#define CCMR_OC13FE_Mask            ((uint16)0x7F7B)
#define CCMR_OC24FE_Mask            ((uint16)0x7B7F)
#define CCMR_OC13PE_Mask            ((uint16)0x7F77)
#define CCMR_OC24PE_Mask            ((uint16)0x777F)
...
#define CCER_CC1P_Mask              ((uint16)0xFFFD)

#define CCER_CC2P_Mask              ((uint16)0xFFDF)
#define CCER_CC3P_Mask              ((uint16)0xFDFF)
#define CCER_CC4P_Mask              ((uint16)0xDFFF)

#define CCRE_CC1E_Set               ((uint16)0x0001)
#define CCRE_CC1E_Reset             ((uint16)0xFFFE)
#define CCRE_CC1E_Mask              ((uint16)0xFFFE)

#define CCRE_CC2E_Set               ((uint16)0x0010)
#define CCRE_CC2E_Reset             ((uint16)0xFFEF)
#define CCRE_CC2E_Mask              ((uint16)0xFFEF)

#define CCRE_CC3E_Set               ((uint16)0x0100)
#define CCRE_CC3E_Reset             ((uint16)0xFEFF)

#define CCRE_CC4E_Set               ((uint16)0x1000)
#define CCRE_CC4E_Reset             ((uint16)0xEFFF)
#define CCRE_CC4E_Mask              ((uint16)0xEFFF)

#define DCR_DMA_Mask                ((uint16)0x0000)

/* TIM private Masks */
#define TIM_Period_Reset_Mask       ((uint16)0x0000)
#define TIM_Prescaler_Reset_Mask    ((uint16)0x0000)
...
static ucint16 Tab_PolarityMask[4] = {CCER_CC1P_Mask, CCER_CC2P_Mask, CCER_CC3P_Mask, CCER_CC4P_Mask};
...
static void TI4_Config(TIM_TypeDef* TIMx, uint16 TIM_ICPolarity, uint16 TIM_ICSelection,
                       uint8 TIM_ICFilter);
static void ETR_Config(TIM_TypeDef* TIMx, uint16 TIM_ExtTRGPrescaler, 
...
void TIM_TimeBaseInit(TIM_TypeDef* TIMx, TIM_TimeBaseInitTypeDef* TIM_TimeBaseInitStruct)
{
  ...
  TIMx->CR1 |= (uint32)TIM_TimeBaseInitStruct->TIM_ClockDivision |
...
void TIM_OCInit(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
  ...
  if ((TIM_OCInitStruct->TIM_Channel == (uint16)TIM_Channel_1) ||
      (TIM_OCInitStruct->TIM_Channel == (uint16)TIM_Channel_2))
  {
    tmpccmrx = TIMx->CCMR1;
    ...
    else /* TIM_Channel_2 */
    {
      ...
      /* Select the Output Compare Mode */
      tmpccmrx |= (uint32)TIM_OCInitStruct->TIM_OCMode << 8;
      ...
      /* Set the Capture Compare Polarity */
      tmpccer |= (uint32)TIM_OCInitStruct->TIM_OCPolarity << 4;
    }

    TIMx->CCMR1 = (uint16)tmpccmrx;
  }
  else 
  {
    ...
    { 
      ...
      if (TIM_OCInitStruct->TIM_Channel == TIM_Channel_3)
      {
        ...
        /* Set the Capture Compare Polarity */
        tmpccer |= (uint32)TIM_OCInitStruct->TIM_OCPolarity << 8;
      }
      else  /* TIM_Channel_4 */
      {
       ...
       /* Select the Output Compare Mode */
        ...
        /* Set the Capture Compare Polarity */
        tmpccer |= (uint32)TIM_OCInitStruct->TIM_OCPolarity << 12;
      }

      TIMx->CCMR2 = (uint16)tmpccmrx;
    }
  }
  
  TIMx->CCER = (uint16)tmpccer;
}
...
void TIM_DMACmd(TIM_TypeDef* TIMx, uint16 TIM_DMASource, FunctionalState Newstate)
{
  ...
  else
  {
    ...
    tmpdier &= (uint16)(~TIM_DMASource);
  }
  TIMx->DIER = (uint16)tmpdier;
}
...
void TIM_TIxExternalClockConfig(TIM_TypeDef* TIMx, uint16 TIM_TIxExternalCLKSource,
                                uint16 TIM_ICPolarity, uint8 ICFilter)
{
  /* Check the parameters */
                                ...
                                uint16 TIM_IC1Polarity, uint16 TIM_IC2Polarity)
{
  ...
  tmpccer |= (TIM_IC1Polarity | (uint16)((uint16)TIM_IC2Polarity << 4));
...
void TIM_OC2PolarityConfig(TIM_TypeDef* TIMx, uint16 TIM_OCPolarity)
{
  ...
  tmpccer |= (uint16)((uint16)TIM_OCPolarity << 4);
...
void TIM_OC3PolarityConfig(TIM_TypeDef* TIMx, uint16 TIM_OCPolarity)
{
  ...
  tmpccer |= (uint16)((uint16)TIM_OCPolarity << 8);
...
void TIM_OC4PolarityConfig(TIM_TypeDef* TIMx, uint16 TIM_OCPolarity)
{
  ...
  tmpccer |= (uint16)((uint16)TIM_OCPolarity << 12);
...
* Return         : None
*******************************************************************************/
void TIM_SetIC1Prescaler(TIM_TypeDef* TIMx, uint16 TIM_IC1Prescaler)
{
  uint32 tmpccmr1 = 0;
...
* Return         : None
*******************************************************************************/
void TIM_SetIC2Prescaler(TIM_TypeDef* TIMx, uint16 TIM_IC2Prescaler)
{
  uint32 tmpccmr1 = 0;
  ...
  tmpccmr1 |= (uint16)((uint16)TIM_IC2Prescaler << 8);
...
* Return         : None
*******************************************************************************/
void TIM_SetIC3Prescaler(TIM_TypeDef* TIMx, uint16 TIM_IC3Prescaler)
{
  uint32 tmpccmr2 = 0;
...
* Return         : None
*******************************************************************************/
void TIM_SetIC4Prescaler(TIM_TypeDef* TIMx, uint16 TIM_IC4Prescaler)
{
  uint32 tmpccmr2 = 0;
  ...
  tmpccmr2 |= (uint16)((uint16)TIM_IC4Prescaler << 8);
...
static void PWMI_Config(TIM_TypeDef* TIMx, TIM_ICInitTypeDef* TIM_ICInitStruct)
{
  uint8 ICPolarity = TIM_ICPolarity_Rising;
  uint8 ICSelection = TIM_ICSelection_DirectTI;
                       ...
                       uint8 TIM_ICFilter)
{
  ...
  tmpccmr1 |= TIM_ICSelection | (uint16)((uint16)TIM_ICFilter << 4);
...
static void TI2_Config(TIM_TypeDef* TIMx, uint16 TIM_ICPolarity, uint16 TIM_ICSelection,
                       uint8 TIM_ICFilter)
{
  uint32 tmpccmr1 = 0, tmpccer = 0, tmp = 0;

  tmpccmr1 = TIMx->CCMR1;
  tmpccer = TIMx->CCER;
  tmp = (uint16)((uint16)TIM_ICPolarity << 4);
  ...
  tmpccmr1 |= (uint16)((uint16)TIM_ICFilter << 12);
  tmpccmr1 |= (uint16)((uint16)TIM_ICSelection << 8);
...
static void TI3_Config(TIM_TypeDef* TIMx, uint16 TIM_ICPolarity, uint16 TIM_ICSelection,
                       uint8 TIM_ICFilter)
{
  uint32 tmpccmr2 = 0, tmpccer = 0, tmp = 0;

  tmpccmr2 = TIMx->CCMR2;
  tmpccer = TIMx->CCER;
  tmp = (uint16)((uint16)TIM_ICPolarity << 8);
  ...
  tmpccmr2 |= TIM_ICSelection | (uint16)((uint16)TIM_ICFilter << 4);
                       ...
                       uint8 TIM_ICFilter)
{
  ...
  tmpccmr2 = TIMx->CCMR2;
  tmpccer = TIMx->CCER;
  tmp = (uint16)((uint16)TIM_ICPolarity << 12);
  ...
  tmpccmr2 |= (uint16)((uint16)TIM_ICSelection << 8) | (uint16)((uint16)TIM_ICFilter << 12);
...
* Return         : None
*******************************************************************************/
static void ETR_Config(TIM_TypeDef* TIMx, uint16 TIM_ExtTRGPrescaler, uint16 TIM_ExtTRGPolarity,
                       uint8 ExtTRGFilter)
{
  uint32 tmpsmcr = 0;
  ...
  tmpsmcr |= TIM_ExtTRGPrescaler | TIM_ExtTRGPolarity | (uint16)((uint16)ExtTRGFilter << 8);
