...
#define SMCR_ETR_Mask               ((uint16)0x00FF)
#define CCMR_Offset                 ((uint16)0x0018)
#define CCER_CCE_Set                ((uint16)0x0001)
#define CCER_CCNE_Set               ((uint16)0x0004)
...
static void TI2_Config(TIM_TypeDef* TIMx, uint16 TIM_ICPolarity, uint16 TIM_ICSelection,
                       uint16 TIM_ICFilter);
static void TI3_Config(TIM_TypeDef* TIMx, uint16 TIM_ICPolarity, uint16 TIM_ICSelection,
                       uint16 TIM_ICFilter);
...
#endif
#ifndef TIM15
static TIM_TypeDef *TIM15;
#endif
#ifndef TIM16
static TIM_TypeDef *TIM16;
#endif
#ifndef TIM17
static TIM_TypeDef *TIM17;
#endif
...
void TIM_TimeBaseInit(TIM_TypeDef* TIMx, TIM_TimeBaseInitTypeDef* TIM_TimeBaseInitStruct)
{
    ...
    if(IS_TIM_LIST3_PERIPH(TIMx))
    {
        /* Select the Counter Mode */
        tmpcr1 &= (uint16)(~((uint16)(TIM_CR1_DIR | TIM_CR1_CMS)));
        tmpcr1 |= (uint32)TIM_TimeBaseInitStruct->TIM_CounterMode;
    }

    if((TIMx != TIM6) && (TIMx != TIM7))
    {
        /* Set the clock division */
        tmpcr1 &= (uint16)(~((uint16)TIM_CR1_CKD));
        tmpcr1 |= (uint32)TIM_TimeBaseInitStruct->TIM_ClockDivision;
    }
...
void TIM_OC1Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
    ...
    TIMx->CCER &= (uint16)(~(uint16)TIM_CCER_CC1E);
    ...
    tmpccmrx &= (uint16)(~((uint16)TIM_CCMR1_OC1M));
    tmpccmrx &= (uint16)(~((uint16)TIM_CCMR1_CC1S));

    /* Select the Output Compare Mode */
    tmpccmrx |= TIM_OCInitStruct->TIM_OCMode;

    /* Reset the Output Polarity level */
    tmpccer &= (uint16)(~((uint16)TIM_CCER_CC1P));
            ...
            (TIMx == TIM16)|| (TIMx == TIM17))
    {
        ...
        tmpccer &= (uint16)(~((uint16)TIM_CCER_CC1NP));
        /* Set the Output N Polarity */
        tmpccer |= TIM_OCInitStruct->TIM_OCNPolarity;

        /* Reset the Output N State */
        tmpccer &= (uint16)(~((uint16)TIM_CCER_CC1NE));
        /* Set the Output N State */
        tmpccer |= TIM_OCInitStruct->TIM_OutputNState;

        /* Reset the Ouput Compare and Output Compare N IDLE State */
        tmpcr2 &= (uint16)(~((uint16)TIM_CR2_OIS1));
        tmpcr2 &= (uint16)(~((uint16)TIM_CR2_OIS1N));
...
void TIM_OC2Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
    ...
    TIMx->CCER &= (uint16)(~((uint16)TIM_CCER_CC2E));
    ...
    tmpccmrx &= (uint16)(~((uint16)TIM_CCMR1_OC2M));
    tmpccmrx &= (uint16)(~((uint16)TIM_CCMR1_CC2S));

    /* Select the Output Compare Mode */
    tmpccmrx |= (uint16)(TIM_OCInitStruct->TIM_OCMode << 8);

    /* Reset the Output Polarity level */
    tmpccer &= (uint16)(~((uint16)TIM_CCER_CC2P));
    /* Set the Output Compare Polarity */
    tmpccer |= (uint16)(TIM_OCInitStruct->TIM_OCPolarity << 4);

    /* Set the Output State */
    tmpccer |= (uint16)(TIM_OCInitStruct->TIM_OutputState << 4);
    ...
    if((TIMx == TIM1) || (TIMx == TIM8))
    {
        ...
        /* Reset the Output N Polarity level */
        tmpccer &= (uint16)(~((uint16)TIM_CCER_CC2NP));
        /* Set the Output N Polarity */
        tmpccer |= (uint16)(TIM_OCInitStruct->TIM_OCNPolarity << 4);

        /* Reset the Output N State */
        tmpccer &= (uint16)(~((uint16)TIM_CCER_CC2NE));
        /* Set the Output N State */
        tmpccer |= (uint16)(TIM_OCInitStruct->TIM_OutputNState << 4);

        /* Reset the Ouput Compare and Output Compare N IDLE State */
        tmpcr2 &= (uint16)(~((uint16)TIM_CR2_OIS2));
        tmpcr2 &= (uint16)(~((uint16)TIM_CR2_OIS2N));

        /* Set the Output Idle state */
        tmpcr2 |= (uint16)(TIM_OCInitStruct->TIM_OCIdleState << 2);
        /* Set the Output N Idle state */
        tmpcr2 |= (uint16)(TIM_OCInitStruct->TIM_OCNIdleState << 2);
    }
    /* Write to TIMx CR2 */
    TIMx->CR2 = tmpcr2;
...
void TIM_OC3Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
    ...
    ASSERT_PARAM(IS_TIM_OC_POLARITY(TIM_OCInitStruct->TIM_OCPolarity));
    /* Disable the Channel 2: Reset the CC2E Bit */
    TIMx->CCER &= (uint16)(~((uint16)TIM_CCER_CC3E));
    ...
    /* Reset the Output Compare mode and Capture/Compare selection Bits */
    tmpccmrx &= (uint16)(~((uint16)TIM_CCMR2_OC3M));
    tmpccmrx &= (uint16)(~((uint16)TIM_CCMR2_CC3S));
    /* Select the Output Compare Mode */
    tmpccmrx |= TIM_OCInitStruct->TIM_OCMode;

    /* Reset the Output Polarity level */
    tmpccer &= (uint16)(~((uint16)TIM_CCER_CC3P));
    /* Set the Output Compare Polarity */
    tmpccer |= (uint16)(TIM_OCInitStruct->TIM_OCPolarity << 8);

    /* Set the Output State */
    tmpccer |= (uint16)(TIM_OCInitStruct->TIM_OutputState << 8);
    ...
    if((TIMx == TIM1) || (TIMx == TIM8))
    {
        ...
        /* Reset the Output N Polarity level */
        tmpccer &= (uint16)(~((uint16)TIM_CCER_CC3NP));
        /* Set the Output N Polarity */
        tmpccer |= (uint16)(TIM_OCInitStruct->TIM_OCNPolarity << 8);
        /* Reset the Output N State */
        tmpccer &= (uint16)(~((uint16)TIM_CCER_CC3NE));

        /* Set the Output N State */
        tmpccer |= (uint16)(TIM_OCInitStruct->TIM_OutputNState << 8);
        /* Reset the Ouput Compare and Output Compare N IDLE State */
        tmpcr2 &= (uint16)(~((uint16)TIM_CR2_OIS3));
        tmpcr2 &= (uint16)(~((uint16)TIM_CR2_OIS3N));
        /* Set the Output Idle state */
        tmpcr2 |= (uint16)(TIM_OCInitStruct->TIM_OCIdleState << 4);
        /* Set the Output N Idle state */
        tmpcr2 |= (uint16)(TIM_OCInitStruct->TIM_OCNIdleState << 4);
    }
    /* Write to TIMx CR2 */
    TIMx->CR2 = tmpcr2;
...
void TIM_OC4Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
    ...
    TIMx->CCER &= (uint16)(~((uint16)TIM_CCER_CC4E));
    ...
    /* Reset the Output Compare mode and Capture/Compare selection Bits */
    tmpccmrx &= (uint16)(~((uint16)TIM_CCMR2_OC4M));
    tmpccmrx &= (uint16)(~((uint16)TIM_CCMR2_CC4S));

    /* Select the Output Compare Mode */
    tmpccmrx |= (uint16)(TIM_OCInitStruct->TIM_OCMode << 8);

    /* Reset the Output Polarity level */
    tmpccer &= (uint16)(~((uint16)TIM_CCER_CC4P));
    /* Set the Output Compare Polarity */
    tmpccer |= (uint16)(TIM_OCInitStruct->TIM_OCPolarity << 12);

    /* Set the Output State */
    tmpccer |= (uint16)(TIM_OCInitStruct->TIM_OutputState << 12);

    if((TIMx == TIM1) || (TIMx == TIM8))
    {
        ASSERT_PARAM(IS_TIM_OCIDLE_STATE(TIM_OCInitStruct->TIM_OCIdleState));
        /* Reset the Ouput Compare IDLE State */
        tmpcr2 &= (uint16)(~((uint16)TIM_CR2_OIS4));
        /* Set the Output Idle state */
        tmpcr2 |= (uint16)(TIM_OCInitStruct->TIM_OCIdleState << 6);
    }
    /* Write to TIMx CR2 */
    TIMx->CR2 = tmpcr2;
...
void TIM_PWMIConfig(TIM_TypeDef* TIMx, TIM_ICInitTypeDef* TIM_ICInitStruct)
{
    ...
    uint16 icoppositeselection = TIM_ICSelection_DirectTI;
    /* Check the parameters */
    ASSERT_PARAM(IS_TIM_LIST6_PERIPH(TIMx));
...
void TIM_BDTRConfig(TIM_TypeDef* TIMx, TIM_BDTRInitTypeDef *TIM_BDTRInitStruct)
{
    ...
    TIMx->BDTR = (uint32)TIM_BDTRInitStruct->TIM_OSSRState | TIM_BDTRInitStruct->TIM_OSSIState |
...
void TIM_Cmd(TIM_TypeDef* TIMx, FunctionalState NewState)
{
    ...
    else
    {
        ...
        TIMx->CR1 &= (uint16)(~((uint16)TIM_CR1_CEN));
    }
}
...
void TIM_InternalClockConfig(TIM_TypeDef* TIMx)
{
    ...
    TIMx->SMCR &=  (uint16)(~((uint16)TIM_SMCR_SMS));
}
                             ...
                             uint16 ExtTRGFilter)
{
    ...
    tmpsmcr = TIMx->SMCR;
    /* Reset the SMS Bits */
    tmpsmcr &= (uint16)(~((uint16)TIM_SMCR_SMS));
    /* Select the External clock mode1 */
    tmpsmcr |= TIM_SlaveMode_External1;
    /* Select the Trigger selection : ETRF */
    tmpsmcr &= (uint16)(~((uint16)TIM_SMCR_TS));
    tmpsmcr |= TIM_TS_ETRF;
    /* Write to TIMx SMCR */
    TIMx->SMCR = tmpsmcr;
}
                   ...
                   uint16 ExtTRGFilter)
{
    ...
    tmpsmcr |= (uint16)(TIM_ExtTRGPrescaler | (uint16)(TIM_ExtTRGPolarity | (uint16)(ExtTRGFilter << (uint16)8)));
    /* Write to TIMx SMCR */
    TIMx->SMCR = tmpsmcr;
}
#endif
                                ...
                                uint16 TIM_IC1Polarity, uint16 TIM_IC2Polarity)
{
    ...
    tmpccmr1 &= (uint16)(((uint16)~((uint16)TIM_CCMR1_CC1S)) & (uint16)(~((uint16)TIM_CCMR1_CC2S)));
    tmpccmr1 |= TIM_CCMR1_CC1S_0 | TIM_CCMR1_CC2S_0;

    /* Set the TI1 and the TI2 Polarities */
    tmpccer &= (uint16)(((uint16)~((uint16)TIM_CCER_CC1P)) & ((uint16)~((uint16)TIM_CCER_CC2P)));
    tmpccer |= (uint16)(TIM_IC1Polarity | (uint16)(TIM_IC2Polarity << (uint16)4));
...
void TIM_ForcedOC1Config(TIM_TypeDef* TIMx, uint16 TIM_ForcedAction)
{
    ...
    tmpccmr1 = TIMx->CCMR1;
    /* Reset the OC1M Bits */
    tmpccmr1 &= (uint16)~((uint16)TIM_CCMR1_OC1M);
...
void TIM_ForcedOC2Config(TIM_TypeDef* TIMx, uint16 TIM_ForcedAction)
{
    ...
    tmpccmr1 = TIMx->CCMR1;
    /* Reset the OC2M Bits */
    tmpccmr1 &= (uint16)~((uint16)TIM_CCMR1_OC2M);
    /* Configure The Forced output Mode */
    tmpccmr1 |= (uint16)(TIM_ForcedAction << 8);
    /* Write to TIMx CCMR1 register */
    TIMx->CCMR1 = tmpccmr1;
}
#endif
...
void TIM_ForcedOC3Config(TIM_TypeDef* TIMx, uint16 TIM_ForcedAction)
{
    ...
    tmpccmr2 = TIMx->CCMR2;
    /* Reset the OC1M Bits */
    tmpccmr2 &= (uint16)~((uint16)TIM_CCMR2_OC3M);
    /* Configure The Forced output Mode */
...
void TIM_ForcedOC4Config(TIM_TypeDef* TIMx, uint16 TIM_ForcedAction)
{
    ...
    tmpccmr2 = TIMx->CCMR2;
    /* Reset the OC2M Bits */
    tmpccmr2 &= (uint16)~((uint16)TIM_CCMR2_OC4M);
    /* Configure The Forced output Mode */
    tmpccmr2 |= (uint16)(TIM_ForcedAction << 8);
    /* Write to TIMx CCMR2 register */
    TIMx->CCMR2 = tmpccmr2;
}
#endif
...
void TIM_ARRPreloadConfig(TIM_TypeDef* TIMx, FunctionalState NewState)
{
    ...
    else
    {
        ...
        TIMx->CR1 &= (uint16)~((uint16)TIM_CR1_ARPE);
    }
}
...
void TIM_SelectCOM(TIM_TypeDef* TIMx, FunctionalState NewState)
{
    ...
    {
        /* Reset the COM Bit */
        TIMx->CR2 &= (uint16)~((uint16)TIM_CR2_CCUS);
    }
}
...
void TIM_OC1PreloadConfig(TIM_TypeDef* TIMx, uint16 TIM_OCPreload)
{
    ...
    tmpccmr1 = TIMx->CCMR1;
    /* Reset the OC1PE Bit */
    tmpccmr1 &= (uint16)~((uint16)TIM_CCMR1_OC1PE);
...
void TIM_OC2PreloadConfig(TIM_TypeDef* TIMx, uint16 TIM_OCPreload)
{
    ...
    tmpccmr1 = TIMx->CCMR1;
    /* Reset the OC2PE Bit */
    tmpccmr1 &= (uint16)~((uint16)TIM_CCMR1_OC2PE);
    /* Enable or Disable the Output Compare Preload feature */
    tmpccmr1 |= (uint16)(TIM_OCPreload << 8);
    /* Write to TIMx CCMR1 register */
    TIMx->CCMR1 = tmpccmr1;
}
#endif
...
void TIM_OC3PreloadConfig(TIM_TypeDef* TIMx, uint16 TIM_OCPreload)
{
    ...
    tmpccmr2 = TIMx->CCMR2;
    /* Reset the OC3PE Bit */
    tmpccmr2 &= (uint16)~((uint16)TIM_CCMR2_OC3PE);
    /* Enable or Disable the Output Compare Preload feature */
...
void TIM_OC4PreloadConfig(TIM_TypeDef* TIMx, uint16 TIM_OCPreload)
{
    ...
    tmpccmr2 = TIMx->CCMR2;
    /* Reset the OC4PE Bit */
    tmpccmr2 &= (uint16)~((uint16)TIM_CCMR2_OC4PE);
    /* Enable or Disable the Output Compare Preload feature */
    tmpccmr2 |= (uint16)(TIM_OCPreload << 8);
    /* Write to TIMx CCMR2 register */
    TIMx->CCMR2 = tmpccmr2;
}
#endif
...
void TIM_OC1FastConfig(TIM_TypeDef* TIMx, uint16 TIM_OCFast)
{
    ...
    tmpccmr1 = TIMx->CCMR1;
    /* Reset the OC1FE Bit */
    tmpccmr1 &= (uint16)~((uint16)TIM_CCMR1_OC1FE);
...
void TIM_OC2FastConfig(TIM_TypeDef* TIMx, uint16 TIM_OCFast)
{
    ...
    tmpccmr1 = TIMx->CCMR1;
    /* Reset the OC2FE Bit */
    tmpccmr1 &= (uint16)~((uint16)TIM_CCMR1_OC2FE);
    /* Enable or Disable the Output Compare Fast Bit */
    tmpccmr1 |= (uint16)(TIM_OCFast << 8);
    /* Write to TIMx CCMR1 */
    TIMx->CCMR1 = tmpccmr1;
}
#endif
...
void TIM_OC3FastConfig(TIM_TypeDef* TIMx, uint16 TIM_OCFast)
{
    ...
    tmpccmr2 = TIMx->CCMR2;
    /* Reset the OC3FE Bit */
    tmpccmr2 &= (uint16)~((uint16)TIM_CCMR2_OC3FE);
    /* Enable or Disable the Output Compare Fast Bit */
    tmpccmr2 |= TIM_OCFast;
    /* Write to TIMx CCMR2 */
    TIMx->CCMR2 = tmpccmr2;
...
void TIM_OC4FastConfig(TIM_TypeDef* TIMx, uint16 TIM_OCFast)
{
    ...
    tmpccmr2 = TIMx->CCMR2;
    /* Reset the OC4FE Bit */
    tmpccmr2 &= (uint16)~((uint16)TIM_CCMR2_OC4FE);
    /* Enable or Disable the Output Compare Fast Bit */
    tmpccmr2 |= (uint16)(TIM_OCFast << 8);
    /* Write to TIMx CCMR2 */
    TIMx->CCMR2 = tmpccmr2;
}
#endif
...
void TIM_ClearOC1Ref(TIM_TypeDef* TIMx, uint16 TIM_OCClear)
{
    ...
    /* Reset the OC1CE Bit */
    tmpccmr1 &= (uint16)~((uint16)TIM_CCMR1_OC1CE);
...
void TIM_ClearOC2Ref(TIM_TypeDef* TIMx, uint16 TIM_OCClear)
{
    ...
    tmpccmr1 = TIMx->CCMR1;
    /* Reset the OC2CE Bit */
    tmpccmr1 &= (uint16)~((uint16)TIM_CCMR1_OC2CE);
    /* Enable or Disable the Output Compare Clear Bit */
    tmpccmr1 |= (uint16)(TIM_OCClear << 8);
    /* Write to TIMx CCMR1 register */
    TIMx->CCMR1 = tmpccmr1;
}
#endif
...
void TIM_ClearOC3Ref(TIM_TypeDef* TIMx, uint16 TIM_OCClear)
{
    ...
    tmpccmr2 = TIMx->CCMR2;
    /* Reset the OC3CE Bit */
    tmpccmr2 &= (uint16)~((uint16)TIM_CCMR2_OC3CE);
    /* Enable or Disable the Output Compare Clear Bit */
...
void TIM_ClearOC4Ref(TIM_TypeDef* TIMx, uint16 TIM_OCClear)
{
    ...
    tmpccmr2 = TIMx->CCMR2;
    /* Reset the OC4CE Bit */
    tmpccmr2 &= (uint16)~((uint16)TIM_CCMR2_OC4CE);
    /* Enable or Disable the Output Compare Clear Bit */
    tmpccmr2 |= (uint16)(TIM_OCClear << 8);
    /* Write to TIMx CCMR2 register */
    TIMx->CCMR2 = tmpccmr2;
}
#endif
...
void TIM_OC2PolarityConfig(TIM_TypeDef* TIMx, uint16 TIM_OCPolarity)
{
    ...
    tmpccer &= (uint16)~((uint16)TIM_CCER_CC2P);
    tmpccer |= (uint16)(TIM_OCPolarity << 4);
    /* Write to TIMx CCER register */
    TIMx->CCER = tmpccer;
}
#endif
...
void TIM_OC2NPolarityConfig(TIM_TypeDef* TIMx, uint16 TIM_OCNPolarity)
{
    ...
    tmpccer &= (uint16)~((uint16)TIM_CCER_CC2NP);
    tmpccer |= (uint16)(TIM_OCNPolarity << 4);
    /* Write to TIMx CCER register */
    TIMx->CCER = tmpccer;
}
#endif
...
void TIM_OC3PolarityConfig(TIM_TypeDef* TIMx, uint16 TIM_OCPolarity)
{
    ...
    tmpccer &= (uint16)~((uint16)TIM_CCER_CC3P);
    tmpccer |= (uint16)(TIM_OCPolarity << 8);
    /* Write to TIMx CCER register */
    TIMx->CCER = tmpccer;
}
#endif
...
void TIM_OC3NPolarityConfig(TIM_TypeDef* TIMx, uint16 TIM_OCNPolarity)
{
    ...
    tmpccer &= (uint16)~((uint16)TIM_CCER_CC3NP);
    tmpccer |= (uint16)(TIM_OCNPolarity << 8);
    /* Write to TIMx CCER register */
    TIMx->CCER = tmpccer;
}
#endif
...
void TIM_OC4PolarityConfig(TIM_TypeDef* TIMx, uint16 TIM_OCPolarity)
{
    ...
    tmpccer &= (uint16)~((uint16)TIM_CCER_CC4P);
    tmpccer |= (uint16)(TIM_OCPolarity << 12);
    /* Write to TIMx CCER register */
    TIMx->CCER = tmpccer;
}
#endif
...
void TIM_SelectOCxM(TIM_TypeDef* TIMx, uint16 TIM_Channel, uint16 TIM_OCMode)
{
    ...
    tmp1 = CCER_CCE_Set << (uint16)TIM_Channel;

    /* Disable the Channel: Reset the CCxE Bit */
    TIMx->CCER &= (uint16) ~tmp1;
    ...
    if((TIM_Channel == TIM_Channel_1) ||(TIM_Channel == TIM_Channel_3))
    {
        ...
        *(vuint32 *) tmp &= (uint32)~((uint32)TIM_CCMR1_OC1M);

        /* Configure the OCxM bits in the CCMRx register */
        *(vuint32 *) tmp |= TIM_OCMode;
    }
    else
    {
        tmp += (uint16)(TIM_Channel - (uint16)4)>> (uint16)1;

        /* Reset the OCxM bits in the CCMRx register */
        *(vuint32 *) tmp &= (uint32)~((uint32)TIM_CCMR1_OC2M);
...
void TIM_UpdateDisableConfig(TIM_TypeDef* TIMx, FunctionalState NewState)
{
    ...
    else
    {
        ...
        TIMx->CR1 &= (uint16)~((uint16)TIM_CR1_UDIS);
    }
}
...
void TIM_UpdateRequestConfig(TIM_TypeDef* TIMx, uint16 TIM_UpdateSource)
{
    ...
    {
        /* Reset the URS Bit */
        TIMx->CR1 &= (uint16)~((uint16)TIM_CR1_URS);
    }
}
...
void TIM_SelectOnePulseMode(TIM_TypeDef* TIMx, uint16 TIM_OPMode)
{
    ...
    /* Reset the OPM Bit */
    TIMx->CR1 &= (uint16)~((uint16)TIM_CR1_OPM);
...
void TIM_SelectOutputTrigger(TIM_TypeDef* TIMx, uint16 TIM_TRGOSource)
{
    ...
    /* Reset the MMS Bits */
    TIMx->CR2 &= (uint16)~((uint16)TIM_CR2_MMS);
...
void TIM_SelectMasterSlaveMode(TIM_TypeDef* TIMx, uint16 TIM_MasterSlaveMode)
{
    ...
    /* Reset the MSM Bit */
    TIMx->SMCR &= (uint16)~((uint16)TIM_SMCR_MSM);
...
void TIM_SetIC1Prescaler(TIM_TypeDef* TIMx, uint16 TIM_ICPSC)
{
    ...
    TIMx->CCMR1 &= (uint16)~((uint16)TIM_CCMR1_IC1PSC);
...
void TIM_SetIC2Prescaler(TIM_TypeDef* TIMx, uint16 TIM_ICPSC)
{
    ...
    TIMx->CCMR1 &= (uint16)~((uint16)TIM_CCMR1_IC2PSC);
...
void TIM_SetIC3Prescaler(TIM_TypeDef* TIMx, uint16 TIM_ICPSC)
{
    ...
    TIMx->CCMR2 &= (uint16)~((uint16)TIM_CCMR2_IC3PSC);
...
void TIM_SetIC4Prescaler(TIM_TypeDef* TIMx, uint16 TIM_ICPSC)
{
    ...
    TIMx->CCMR2 &= (uint16)~((uint16)TIM_CCMR2_IC4PSC);
...
void TIM_SetClockDivision(TIM_TypeDef* TIMx, uint16 TIM_CKD)
{
    ...
    /* Reset the CKD Bits */
    TIMx->CR1 &= (uint16)~((uint16)TIM_CR1_CKD);
    /* Set the CKD value */
    TIMx->CR1 |= TIM_CKD;
}
...
FlagStatus TIM_GetFlagStatus(TIM_TypeDef* TIMx, uint16 TIM_FLAG)
{
    ...
    if ((TIMx->SR & TIM_FLAG) != (uint16)RESET)
    {
        bitstatus = SET;
    }
    else
...
{
    ITStatus bitstatus = RESET;
    uint16 itstatus = 0x0, itenable = 0x0;
    /* Check the parameters */
    ASSERT_PARAM(IS_TIM_ALL_PERIPH(TIMx));
...
static void TI1_Config(TIM_TypeDef* TIMx, uint16 TIM_ICPolarity, uint16 TIM_ICSelection,
                       uint16 TIM_ICFilter)
{
    uint16 tmpccmr1 = 0, tmpccer = 0;
    /* Disable the Channel 1: Reset the CC1E Bit */
    TIMx->CCER &= (uint16)~((uint16)TIM_CCER_CC1E);
    tmpccmr1 = TIMx->CCMR1;
    tmpccer = TIMx->CCER;
    /* Select the Input and set the filter */
    tmpccmr1 &= (uint16)(((uint16)~((uint16)TIM_CCMR1_CC1S)) & ((uint16)~((uint16)TIM_CCMR1_IC1F)));
    tmpccmr1 |= (uint16)(TIM_ICSelection | (uint16)(TIM_ICFilter << (uint16)4));
            ...
            (TIMx == TIM4) ||(TIMx == TIM5))
    {
        ...
        tmpccer &= (uint16)~((uint16)(TIM_CCER_CC1P));
        tmpccer |= (uint16)(TIM_ICPolarity | (uint16)TIM_CCER_CC1E);
    }
    else
    {
        /* Select the Polarity and set the CC1E Bit */
        tmpccer &= (uint16)~((uint16)(TIM_CCER_CC1P | TIM_CCER_CC1NP));
        tmpccer |= (uint16)(TIM_ICPolarity | (uint16)TIM_CCER_CC1E);
    }
...
static void TI2_Config(TIM_TypeDef* TIMx, uint16 TIM_ICPolarity, uint16 TIM_ICSelection,
                       uint16 TIM_ICFilter)
{
    uint16 tmpccmr1 = 0, tmpccer = 0, tmp = 0;
    /* Disable the Channel 2: Reset the CC2E Bit */
    TIMx->CCER &= (uint16)~((uint16)TIM_CCER_CC2E);
    tmpccmr1 = TIMx->CCMR1;
    tmpccer = TIMx->CCER;
    tmp = (uint16)(TIM_ICPolarity << 4);
    /* Select the Input and set the filter */
    tmpccmr1 &= (uint16)(((uint16)~((uint16)TIM_CCMR1_CC2S)) & ((uint16)~((uint16)TIM_CCMR1_IC2F)));
    tmpccmr1 |= (uint16)(TIM_ICFilter << 12);
    tmpccmr1 |= (uint16)(TIM_ICSelection << 8);
            ...
            (TIMx == TIM4) ||(TIMx == TIM5))
    {
        ...
        tmpccer &= (uint16)~((uint16)(TIM_CCER_CC2P));
        tmpccer |=  (uint16)(tmp | (uint16)TIM_CCER_CC2E);
    }
    else
    {
        /* Select the Polarity and set the CC2E Bit */
        tmpccer &= (uint16)~((uint16)(TIM_CCER_CC2P | TIM_CCER_CC2NP));
        tmpccer |= (uint16)(TIM_ICPolarity | (uint16)TIM_CCER_CC2E);
    }
...
static void TI3_Config(TIM_TypeDef* TIMx, uint16 TIM_ICPolarity, uint16 TIM_ICSelection,
                       uint16 TIM_ICFilter)
{
    uint16 tmpccmr2 = 0, tmpccer = 0, tmp = 0;
    /* Disable the Channel 3: Reset the CC3E Bit */
    TIMx->CCER &= (uint16)~((uint16)TIM_CCER_CC3E);
    tmpccmr2 = TIMx->CCMR2;
    tmpccer = TIMx->CCER;
    tmp = (uint16)(TIM_ICPolarity << 8);
    /* Select the Input and set the filter */
    tmpccmr2 &= (uint16)(((uint16)~((uint16)TIM_CCMR2_CC3S)) & ((uint16)~((uint16)TIM_CCMR2_IC3F)));
    tmpccmr2 |= (uint16)(TIM_ICSelection | (uint16)(TIM_ICFilter << (uint16)4));
            ...
            (TIMx == TIM4) ||(TIMx == TIM5))
    {
        ...
        tmpccer &= (uint16)~((uint16)(TIM_CCER_CC3P));
        tmpccer |= (uint16)(tmp | (uint16)TIM_CCER_CC3E);
    }
    else
    {
        /* Select the Polarity and set the CC3E Bit */
        tmpccer &= (uint16)~((uint16)(TIM_CCER_CC3P | TIM_CCER_CC3NP));
        tmpccer |= (uint16)(TIM_ICPolarity | (uint16)TIM_CCER_CC3E);
    }
                       ...
                       uint16 TIM_ICFilter)
{
    ...
    tmpccmr2 = TIMx->CCMR2;
    tmpccer = TIMx->CCER;
    tmp = (uint16)(TIM_ICPolarity << 12);
    /* Select the Input and set the filter */
    tmpccmr2 &= (uint16)((uint16)(~(uint16)TIM_CCMR2_CC4S) & ((uint16)~((uint16)TIM_CCMR2_IC4F)));
    tmpccmr2 |= (uint16)(TIM_ICSelection << 8);
    tmpccmr2 |= (uint16)(TIM_ICFilter << 12);
            ...
            (TIMx == TIM4) ||(TIMx == TIM5))
    {
        ...
        tmpccer &= (uint16)~((uint16)(TIM_CCER_CC4P));
        tmpccer |= (uint16)(tmp | (uint16)TIM_CCER_CC4E);
    }
    else
    {
        /* Select the Polarity and set the CC4E Bit */
        tmpccer &= (uint16)~((uint16)(TIM_CCER_CC3P | TIM_CCER_CC4NP));
        tmpccer |= (uint16)(TIM_ICPolarity | (uint16)TIM_CCER_CC4E);
    }
    /* Write to TIMx CCMR2 and CCER registers */
    TIMx->CCMR2 = tmpccmr2;
    TIMx->CCER = tmpccer;
