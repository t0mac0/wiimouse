...
typedef struct
{
  uint16 TIM_Period;          /* Period value */
  uint16 TIM_Prescaler;       /* Prescaler value */
  uint16 TIM_ClockDivision;   /* Timer clock division */
  uint16 TIM_CounterMode;     /* Timer Counter mode */
} TIM_TimeBaseInitTypeDef;

/* TIM Output Compare Init structure definition */
typedef struct
{
  uint16 TIM_OCMode;          /* Timer Output Compare Mode */
  uint16 TIM_Channel;          /* Timer Channel */
  uint16 TIM_Pulse;           /* PWM or OC Channel pulse length */
  uint16 TIM_OCPolarity;       /* PWM, OCM or OPM Channel polarity */
} TIM_OCInitTypeDef;

/* TIM Input Capture Init structure definition */
typedef struct
{
  uint16 TIM_ICMode;            /* Timer Input Capture Mode */
  uint16 TIM_Channel;           /* Timer Channel */
  uint16 TIM_ICPolarity;        /* Input Capture polarity */ 
  uint16 TIM_ICSelection;       /* Input Capture selection */
  uint16 TIM_ICPrescaler;       /* Input Capture prescaler */
  uint8 TIM_ICFilter;          /* Input Capture filter */
} TIM_ICInitTypeDef;
...
#define TIM_ICMode_ICAP                   ((uint16)0x0007)
#define TIM_ICMode_PWMI                   ((uint16)0x0006)
...
#define TIM_Channel_2                     ((uint16)0x0001)
#define TIM_Channel_3                     ((uint16)0x0002)
#define TIM_Channel_4                     ((uint16)0x0003)
...
#define TIM_ICSelection_DirectTI          ((uint16)0x0001)
#define TIM_ICSelection_IndirectTI        ((uint16)0x0002)
#define TIM_ICSelection_TRGI              ((uint16)0x0003)
...
#define TIM_ICPSC_DIV1                    ((uint16)0x0000)
#define TIM_ICPSC_DIV2                    ((uint16)0x0004)
#define TIM_ICPSC_DIV4                    ((uint16)0x0008)
#define TIM_ICPSC_DIV8                    ((uint16)0x000C)
...
#define IS_TIM_IT(IT) (((IT & (uint16)0xFFA0) == 0x0000) && (IT != 0x0000))
...
#define IS_TIM_DMA_SOURCE(SOURCE) (((SOURCE & (uint16)0xA0FF) == 0x0000) && (SOURCE != 0x0000))
...
#define IS_TIM_EVENT_SOURCE(SOURCE) (((SOURCE & (uint16)0xFFA0) == 0x0000) && (SOURCE != 0x0000))
                                     

/* TIM Update Source --------------------------------------------------------*/
#define TIM_UpdateSource_Global           ((uint16)0x0000)
#define TIM_UpdateSource_Regular          ((uint16)0x0001)
...
#define IS_TIM_CLEAR_FLAG(FLAG) (((FLAG & (uint16)0xE1A0) == 0x0000) && (FLAG != 0x0000)) 
...
void TIM_ETRClockMode1Config(TIM_TypeDef* TIMx, uint16 TIM_ExtTRGPrescaler, uint16 TIM_ExtTRGPolarity, 
                             uint8 ExtTRGFilter);
void TIM_ETRClockMode2Config(TIM_TypeDef* TIMx, uint16 TIM_ExtTRGPrescaler, uint16 TIM_ExtTRGPolarity, 
                             uint8 ExtTRGFilter);
