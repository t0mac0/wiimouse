...
enum {
    ...
    OS_TASK_MGR_RESULT_START_SCHEDULER_FAIL     = RESULT_ERROR(4),
};
...
#define OS_TASK_MGR_RESULT(code)( RESULT(GET_CURRENT_TASK_ID(), MOD_MGR_OS, NULL_MOD, OS_TASK_MGR_RESULT_##code))

#define OS_TASK_MGR_RESULT_INIT()(OS_TASK_MGR_RESULT(NULL))
