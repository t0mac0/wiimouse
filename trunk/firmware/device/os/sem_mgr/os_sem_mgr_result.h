...
#define OS_SEM_MGR_RESULT(code)( RESULT(GET_CURRENT_TASK_ID(), MOD_MGR_OS, NULL_MOD, OS_SEM_MGR_RESULT_##code))

#define OS_SEM_MGR_RESULT_INIT()(OS_SEM_MGR_RESULT(NULL))
