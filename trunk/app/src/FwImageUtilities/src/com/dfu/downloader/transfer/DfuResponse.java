...
public class DfuResponse extends DfuPacket {
	...
	public static int RESPONSE_SIZE = 21;
	...
	public DfuResponse packetToObject(){
		...
		checkSum = ConversionUtil.byteArrayToIntBE(packetBuffer, 9);
		length = ConversionUtil.byteArrayToIntBE(packetBuffer, 13);
		mode = DfuModeType.getMode(ConversionUtil.byteArrayToIntBE(packetBuffer, 17));
