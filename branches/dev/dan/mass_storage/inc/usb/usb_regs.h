...
#define EP0_IN      ((uint8)0x80)
#define EP1_OUT     ((uint8)0x01)
#define EP1_IN      ((uint8)0x81)
#define EP2_OUT     ((uint8)0x02)
#define EP2_IN      ((uint8)0x82)
#define EP3_OUT     ((uint8)0x03)
#define EP3_IN      ((uint8)0x83)
#define EP4_OUT     ((uint8)0x04)
#define EP4_IN      ((uint8)0x84)
#define EP5_OUT     ((uint8)0x05)
#define EP5_IN      ((uint8)0x85)
#define EP6_OUT     ((uint8)0x06)
#define EP6_IN      ((uint8)0x86)
#define EP7_OUT     ((uint8)0x07)
#define EP7_IN      ((uint8)0x87)
...
/* External variables --------------------------------------------------------*/
extern __IO uint16 wIstr;  /* ISTR register last read value */
