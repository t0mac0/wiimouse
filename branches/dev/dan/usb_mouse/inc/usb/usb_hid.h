/********************************************************************************
USB HID (Human Interface Device) Definitions
...
Note: Designed for the LPC2378
 
Modified by: Dan Riedler
...
#define HID_DESCRIPTOR_SIZE sizeof(HID_DESCRIPTOR)
...
#define HID_USAGE_GENERIC_uint8_COUNT            0x3B
